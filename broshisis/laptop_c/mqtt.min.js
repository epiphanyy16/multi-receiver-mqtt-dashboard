...
var mqtt = (() => {
  ...
  var j = (t, e) => () => (e || t((e = { exports: {} }).exports, e), e.exports),
    Kr = (t, e) => {
      for (var r in e) as(t, r, { get: e[r], enumerable: !0 });
    },
    Zb = (t, e, r, n) => {
  ...
  Kr(N, {
    ...
    _exiting: () => Oc,
    _fatalExceptions: () => Hc,
    _getActiveHandles: () => Bc,
    _getActiveRequests: () => Cc,
    _kill: () => Nc,
    _linkedBinding: () => Tc,
    _maxListeners: () => ff,
    _preload_modules: () => uf,
    _rawDebug: () => Ic,
    _startProfilerIdleNotifier: () => Yc,
    _stopProfilerIdleNotifier: () => Jc,
    _tickCallback: () => zc,
    abort: () => tf,
    addListener: () => pf,
    ...
    exit: () => Dc,
    features: () => $c,
    hasUncaughtExceptionCaptureCallback: () => Gc,
    hrtime: () => Oi,
    kill: () => Uc,
    listeners: () => Sf,
    memoryUsage: () => Lc,
    ...
    ppid: () => nf,
    prependListener: () => _f,
    prependOnceListener: () => vf,
    reallyExit: () => Mc,
    release: () => Ec,
    removeAllListeners: () => wf,
    removeListener: () => bf,
    resourceUsage: () => qc,
    setSourceMapsEnabled: () => lf,
    setUncaughtExceptionCaptureCallback: () => Vc,
    stderr: () => Zc,
    stdin: () => ef,
    stdout: () => Xc,
    title: () => cc,
  ...
  function ew() {
    !Qr ||
      !wr ||
      ((Qr = !1),
      wr.length ? (Mt = wr.concat(Mt)) : (Pi = -1),
      Mt.length && ac());
  }
  function ac() {
    if (!Qr) {
  ...
  function uc(t) {
    ...
    (Mt.push(new lc(t, e)), Mt.length === 1 && !Qr && setTimeout(ac, 0));
  }
  function lc(t, e) {
  ...
  function Oi(t) {
    var e = Math.floor((Date.now() - Jt.now()) * 0.001),
      r = Jt.now() * 0.001,
      n = Math.floor(r) + e,
      i = Math.floor((r % 1) * 1e9);
    return (
      t && ((n = n - t[0]), (i = i - t[1]), i < 0 && (n--, (i += ls))),
      [n, i]
    );
  }
  function Nt() {
  ...
  var Mt,
    ...
    Af = ze(() => {
      ...
      ((cc = "browser"),
        ...
        (Sc = function (t) {}),
        (Ec = { name: "node", sourceUrl: "", headersUrl: "", libUrl: "" }));
      ((Ac = !0), (Ic = Ue), (xc = []));
      ((Pc = {}), (Oc = !1), (Rc = {}));
      ((Mc = Ue),
        (Nc = Ue),
  ...
  function tw() {
    ...
    function f(g) {
      ...
      for (y = 0; y < T; y += 4)
        ((P =
          (e[g.charCodeAt(y)] << 18) |
          (e[g.charCodeAt(y + 1)] << 12) |
          (e[g.charCodeAt(y + 2)] << 6) |
          e[g.charCodeAt(y + 3)]),
          (_[R++] = (P >> 16) & 255),
          (_[R++] = (P >> 8) & 255),
          (_[R++] = P & 255));
      return (
        w === 2 &&
          ((P = (e[g.charCodeAt(y)] << 2) | (e[g.charCodeAt(y + 1)] >> 4)),
          (_[R++] = P & 255)),
        w === 1 &&
          ((P =
            (e[g.charCodeAt(y)] << 10) |
            (e[g.charCodeAt(y + 1)] << 4) |
            (e[g.charCodeAt(y + 2)] >> 2)),
          (_[R++] = (P >> 8) & 255),
          (_[R++] = P & 255)),
        _
      );
    ...
    function h(g) {
      return (
        t[(g >> 18) & 63] + t[(g >> 12) & 63] + t[(g >> 6) & 63] + t[g & 63]
      );
    }
    function d(g, P, S) {
      for (var b, w = [], _ = P; _ < S; _ += 3)
        ((b =
          ((g[_] << 16) & 16711680) +
          ((g[_ + 1] << 8) & 65280) +
          (g[_ + 2] & 255)),
    ...
    function m(g) {
      for (
        var P, S = g.length, b = S % 3, w = [], _ = 16383, R = 0, T = S - b;
        R < T;
        R += _
      )
        w.push(d(g, R, R + _ > T ? T : R + _));
      return (
        b === 1
          ? ((P = g[S - 1]), w.push(t[P >> 2] + t[(P << 4) & 63] + "=="))
          : b === 2 &&
            ((P = (g[S - 2] << 8) + g[S - 1]),
            w.push(t[P >> 10] + t[(P >> 4) & 63] + t[(P << 2) & 63] + "=")),
        w.join("")
      );
    }
    return On;
    ...
    return (
      (ki.read = function (t, e, r, n, i) {
        var s,
          ...
          g = t[e + d];
        for (
          d += m, s = g & ((1 << -h) - 1), g >>= -h, h += a;
          h > 0;
          s = s * 256 + t[e + d], d += m, h -= 8
        );
        for (
          o = s & ((1 << -h) - 1), s >>= -h, h += n;
          h > 0;
          o = o * 256 + t[e + d], d += m, h -= 8
        );
        if (s === 0) s = 1 - f;
        else {
          ...
          e = Math.abs(e),
            isNaN(e) || e === 1 / 0
              ...
              : ((o = Math.floor(Math.log(e) / Math.LN2)),
                ...
                o + d >= 1 ? (e += m / c) : (e += m * Math.pow(2, 1 - d)),
                e * c >= 2 && (o++, (c /= 2)),
                o + d >= h
                  ? ((a = 0), (o = h))
                  : o + d >= 1
                    ? ((a = (e * c - 1) * Math.pow(2, i)), (o = o + d))
                    : ((a = e * Math.pow(2, d - 1) * Math.pow(2, i)), (o = 0)));
          i >= 8;
          t[r + g] = a & 255, g += P, a /= 256, i -= 8
        );
        for (
          o = (o << i) | a, f += i;
          f > 0;
          t[r + g] = o & 255, g += P, o /= 256, f -= 8
        );
        t[r + g - P] |= S * 128;
      }),
      ki
  ...
  function Pf() {
    ...
    function a(p, u, l) {
      ...
      if (
        Ze(p, ArrayBuffer) ||
        (p && Ze(p.buffer, ArrayBuffer)) ||
        (typeof SharedArrayBuffer < "u" &&
          (Ze(p, SharedArrayBuffer) || (p && Ze(p.buffer, SharedArrayBuffer))))
      )
        return P(p, u, l);
      if (typeof p == "number")
        throw new TypeError(
      ...
      if (
        ...
        return o.from(p[Symbol.toPrimitive]("string"), u, l);
      throw new TypeError(
        "The first argument must be one of type string, Buffer, ArrayBuffer, Array, or Array-like Object. Received type " +
          typeof p,
      );
    ...
    function d(p, u) {
      if (
        ((typeof u != "string" || u === "") && (u = "utf8"), !o.isEncoding(u))
      )
    ...
    function m(p) {
      let u = p.length < 0 ? 0 : b(p.length) | 0,
        l = s(u);
    ...
    function P(p, u, l) {
      ...
      return (
        u === void 0 && l === void 0
          ? (E = new Uint8Array(p))
          : l === void 0
            ? (E = new Uint8Array(p, u))
            : (E = new Uint8Array(p, u, l)),
    ...
    function S(p) {
      ...
      if (p.length !== void 0)
        return typeof p.length != "number" || Tn(p.length) ? s(0) : m(p);
    ...
    ((o.isBuffer = function (u) {
      ...
      (o.compare = function (u, l) {
        if (
          (Ze(u, Uint8Array) && (u = o.from(u, u.offset, u.byteLength)),
          Ze(l, Uint8Array) && (l = o.from(l, l.offset, l.byteLength)),
      ...
      (o.concat = function (u, l) {
        ...
        let E;
        if (l === void 0)
          for (l = 0, E = 0; E < u.length; ++E) l += u[E].length;
        ...
        for (E = 0; E < u.length; ++E) {
          ...
          if (Ze($, Uint8Array))
            q + $.length > C.length
              ? (o.isBuffer($) || ($ = o.from($)), $.copy(C, q))
              : Uint8Array.prototype.set.call(C, $, q);
    ...
    ((o.prototype.swap16 = function () {
      ...
      (o.prototype.compare = function (u, l, E, C, q) {
        if (
          (Ze(u, Uint8Array) && (u = o.from(u, u.offset, u.byteLength)),
          !o.isBuffer(u))
        )
        ...
        if (
          (l === void 0 && (l = 0),
          E === void 0 && (E = u ? u.length : 0),
          C === void 0 && (C = 0),
          q === void 0 && (q = this.length),
          l < 0 || E > u.length || C < 0 || q > this.length)
        )
          throw new RangeError("out of range index");
        if (C >= q && l >= E) return 0;
        if (C >= q) return -1;
        if (l >= E) return 1;
        if (((l >>>= 0), (E >>>= 0), (C >>>= 0), (q >>>= 0), this === u))
          return 0;
        let $ = q - C,
          k = E - l,
          B = Math.min($, k),
    ...
    function y(p, u, l, E, C) {
      ...
      if ((typeof u == "string" && (u = o.from(u, E)), o.isBuffer(u)))
        return u.length === 0 ? -1 : O(p, u, l, E, C);
      if (typeof u == "number")
        return (
          (u = u & 255),
          typeof Uint8Array.prototype.indexOf == "function"
            ? C
              ? Uint8Array.prototype.indexOf.call(p, u, l)
              : Uint8Array.prototype.lastIndexOf.call(p, u, l)
            : O(p, [u], l, E, C)
        );
    ...
    ((o.prototype.write = function (u, l, E, C) {
      if (l === void 0) ((C = "utf8"), (E = this.length), (l = 0));
        ...
        ((C = l), (E = this.length), (l = 0));
      else if (isFinite(l))
        ((l = l >>> 0),
          isFinite(E)
            ? ((E = E >>> 0), C === void 0 && (C = "utf8"))
            : ((C = E), (E = void 0)));
      else
        throw new Error(
      ...
      if (
        ((E === void 0 || E > q) && (E = q),
        (u.length > 0 && (E < 0 || l < 0)) || l > this.length)
      )
    ...
    function W(p, u, l) {
      return u === 0 && l === p.length
        ? t.fromByteArray(p)
        : t.fromByteArray(p.slice(u, l));
    }
    function H(p, u, l) {
          ...
          switch (k) {
            ...
            case 3:
              ((B = p[C + 1]),
                ...
                (B & 192) === 128 &&
                  (re & 192) === 128 &&
                  ((oe = ((q & 15) << 12) | ((B & 63) << 6) | (re & 63)),
                  oe > 2047 && (oe < 55296 || oe > 57343) && ($ = oe)));
              break;
            case 4:
              ((B = p[C + 1]),
                (re = p[C + 2]),
    ...
    function J(p) {
      ...
      let l = "",
        E = 0;
      for (; E < u;)
        l += String.fromCharCode.apply(String, p.slice(E, (E += z)));
      return l;
    }
    function ee(p, u, l) {
      let E = "";
    ...
    function te(p, u, l) {
      let E = p.slice(u, l),
        C = "";
      for (let q = 0; q < E.length - 1; q += 2)
        C += String.fromCharCode(E[q] + E[q + 1] * 256);
      return C;
    }
    ...
    ((o.prototype.readUintLE = o.prototype.readUIntLE =
      ...
      (o.prototype.readBigUInt64LE = at(function (u) {
        ...
        let C =
          ...
          q =
            this[++u] + this[++u] * 2 ** 8 + this[++u] * 2 ** 16 + E * 2 ** 24;
      ...
      (o.prototype.readBigUInt64BE = at(function (u) {
        ...
        let C =
          ...
          q =
            this[++u] * 2 ** 24 + this[++u] * 2 ** 16 + this[++u] * 2 ** 8 + E;
    ...
    ((o.prototype.writeBigUInt64LE = at(function (u, l = 0) {
      ...
      (o.prototype.writeIntLE = function (u, l, E, C) {
        ...
        let q = 0,
          $ = 1,
          k = 0;
        for (this[l] = u & 255; ++q < E && ($ *= 256);)
          (u < 0 && k === 0 && this[l + q - 1] !== 0 && (k = 1),
            (this[l + q] = (((u / $) >> 0) - k) & 255));
        return l + E;
      }),
      ...
      (o.prototype.writeInt32LE = function (u, l, E) {
        return (
          (u = +u),
          (l = l >>> 0),
          E || X(this, u, l, 4, 2147483647, -2147483648),
          (this[l] = u & 255),
          (this[l + 1] = u >>> 8),
          (this[l + 2] = u >>> 16),
          (this[l + 3] = u >>> 24),
    ...
    ((o.prototype.writeDoubleLE = function (u, l, E) {
      ...
      (o.prototype.copy = function (u, l, E, C) {
        ...
        (C > this.length && (C = this.length),
          u.length - l < C - E && (C = u.length - l + E));
        let q = C - E;
        return (
          this === u && typeof Uint8Array.prototype.copyWithin == "function"
            ? this.copyWithin(l, E, C)
            : Uint8Array.prototype.set.call(u, this.subarray(E, C), l),
          q
        );
      }),
      (o.prototype.fill = function (u, l, E, C) {
        if (typeof u == "string") {
          if (
            (typeof l == "string"
              ? ((C = l), (l = 0), (E = this.length))
              : typeof E == "string" && ((C = E), (E = this.length)),
    ...
    (Ae(
      ...
      Ae(
        "ERR_OUT_OF_RANGE",
        function (p, u, l) {
          let E = `The value of "${p}" is out of range.`,
            C = l;
          return (
    ...
    function ve(p, u, l) {
      (xe(u, "offset"),
        (p[u] === void 0 || p[u + l] === void 0) && st(u, p.length - (l + 1)));
    }
    function Oe(p, u, l, E, C, q) {
      if (p > l || p < u) {
        let $ = typeof u == "bigint" ? "n" : "",
          k;
        throw (
          u === 0 || u === BigInt(0)
            ? (k = `>= 0${$} and < 2${$} ** ${(q + 1) * 8}${$}`)
            : (k = `>= -(2${$} ** ${(q + 1) * 8 - 1}${$}) and < 2 ** ${(q + 1) * 8 - 1}${$}`),
          new ye.ERR_OUT_OF_RANGE("value", k, p)
        );
      }
      ve(E, C, q);
    }
    function xe(p, u) {
      if (typeof p != "number")
        throw new ye.ERR_INVALID_ARG_TYPE(u, "number", p);
    }
    function st(p, u, l) {
      throw Math.floor(p) !== p
        ? (xe(p, l), new ye.ERR_OUT_OF_RANGE("offset", "an integer", p))
        : u < 0
          ? new ye.ERR_BUFFER_OUT_OF_BOUNDS()
          : new ye.ERR_OUT_OF_RANGE("offset", `>= 0 and <= ${u}`, p);
    }
    let Re = /[^+/0-9A-Za-z-_]/g;
    function Ne(p) {
      if (((p = p.split("=")[0]), (p = p.trim().replace(Re, "")), p.length < 2))
        return "";
    ...
    function Vr(p, u, l, E) {
      let C;
      for (C = 0; C < E && !(C + l >= u.length || C >= p.length); ++C)
        u[C + l] = p[C];
      return C;
    }
    function Ze(p, u) {
...
`;
  ...
  var De = j((jP, Mf) => {
    ...
    x();
    I();
    var { format: ow, inspect: Ci } = hs(),
      { AggregateError: sw } = Ee(),
      aw = globalThis.AggregateError || sw,
      uw = Symbol("kIsNodeError"),
      lw = [
        "string",
        "function",
        "number",
    ...
    var ds = class extends Error {
      constructor(e = "The operation was aborted", r = void 0) {
        if (r !== void 0 && typeof r != "object")
          throw new Bi.ERR_INVALID_ARG_TYPE("options", "Object", r);
    ...
    Le(
      "ERR_INVALID_ARG_TYPE",
      (t, e, r) => {
        (_r(typeof t == "string", "'name' must be a string"),
          Array.isArray(e) || (e = [e]));
        let n = "The ";
        (t.endsWith(" argument")
          ? (n += `${t} `)
        ...
        if (r == null) n += `. Received ${r}`;
          ...
          let c = Ci(r, { colors: !1 });
          (c.length > 25 && (c = `${c.slice(0, 25)}...`),
            (n += `. Received type ${typeof r} (${c})`));
        }
        return n;
      },
      TypeError,
    ...
    Le(
      ...
      (t, e, r = "is invalid") => {
        ...
        return (
          ...
          `The ${t.includes(".") ? "property" : "argument"} '${t}' ${r}. Received ${n}`
        );
      },
      TypeError,
    );
    ...
    Le(
      ...
      (t, e, r) => {
        ...
        let n;
        if (Number.isInteger(r) && Math.abs(r) > 2 ** 32) n = Cf(String(r));
  ...
  function yw() {
    ...
    ((s.prototype.getMaxListeners = function () {
      ...
      (s.prototype.emit = function (y) {
        ...
        if (typeof W == "function") e(W, this, O);
          ...
          for (var H = W.length, z = P(W, H), v = 0; v < H; ++v)
            e(z[v], this, O);
        return !0;
      }));
    function f(T, y, O, v) {
      ...
      if (
        ...
        F === void 0
          ...
          : (F.newListener !== void 0 &&
              (T.emit("newListener", y, O.listener ? O.listener : O),
              (F = T._events)),
            (U = F[y])),
        U === void 0)
      )
        ((U = F[y] = O), ++T._eventsCount);
      else if (
        (typeof U == "function"
          ? (U = F[y] = v ? [O, U] : [U, O])
          : v
    ...
    ((s.prototype.addListener = function (y, O) {
      ...
      (s.prototype.prependListener = function (y, O) {
        return f(this, y, O, !0);
      }));
    function h() {
      if (!this.fired)
    ...
    function d(T, y, O) {
      var v = { fired: !1, wrapFn: void 0, target: T, type: y, listener: O },
        M = h.bind(v);
      ...
      (s.prototype.removeListener = function (y, O) {
        ...
        if (v === O || v.listener === O)
          --this._eventsCount === 0
            ...
            : (delete M[y],
              M.removeListener &&
                this.emit("removeListener", y, v.listener || O));
        else if (typeof v != "function") {
          for (F = -1, U = v.length - 1; U >= 0; U--)
            if (v[U] === O || v[U].listener === O) {
              ((Q = v[U].listener), (F = U));
              break;
            }
          if (F < 0) return this;
          (F === 0 ? v.shift() : S(v, F),
            ...
            M.removeListener !== void 0 &&
              this.emit("removeListener", y, Q || O));
        }
        return this;
      }),
      ...
      (s.prototype.removeAllListeners = function (y) {
        ...
        if (arguments.length === 0) {
          ...
          for (M = 0; M < F.length; ++M)
            ((U = F[M]), U !== "removeListener" && this.removeAllListeners(U));
          return (
        ...
        if (((O = v[y]), typeof O == "function")) this.removeListener(y, O);
          ...
          for (M = O.length - 1; M >= 0; M--) this.removeListener(y, O[M]);
        return this;
      }));
    function m(T, y, O) {
      var v = T._events;
    ...
    function b(T) {
      for (var y = new Array(T.length), O = 0; O < y.length; ++O)
        y[O] = T[O].listener || T[O];
      return y;
    }
    function w(T, y) {
    ...
    function R(T, y, O, v) {
      if (typeof T.on == "function") v.once ? T.once(y, O) : T.on(y, O);
        ...
        T.addEventListener(y, function M(F) {
          ...
          o = {
            async next() {
              ...
              return s
                ...
                : new Promise((h, d) => n.push({ resolve: h, reject: d }));
            },
            async return() {
  ...
  var $e = j((sO, ys) => {
    ...
    I();
    var Sw = (ke(), me(qe)),
      { format: Ew, inspect: Aw } = hs(),
      {
        codes: { ERR_INVALID_ARG_TYPE: ps },
      } = De(),
      {
        kResistStopPropagation: Iw,
        AggregateError: xw,
        SymbolDispose: Tw,
      } = Ee(),
      Pw = globalThis.AbortSignal || Yr().AbortSignal,
      Ow = globalThis.AbortController || Yr().AbortController,
      Rw = Object.getPrototypeOf(async function () {}).constructor,
      Lf = globalThis.Blob || Sw.Blob,
      kw =
        typeof Lf < "u"
          ? function (e) {
    ...
    ys.exports = {
      ...
      addAbortListener:
        (er(), me(Zt)).addAbortListener ||
        function (e, r) {
          if (e === void 0) throw new ps("signal", "AbortSignal", e);
          (Uf(e, "signal"), Cw(r, "listener"));
          let n;
          return (
            e.aborted
              ? queueMicrotask(() => r())
      ...
      AbortSignalAny:
        ...
        function (e) {
          ...
          return (
            e.forEach((i) => {
              (Uf(i, "signals"), i.addEventListener("abort", n, { once: !0 }));
            }),
  ...
  var Xr = j((dO, Kf) => {
    ...
    var {
        ArrayIsArray: bs,
        ArrayPrototypeIncludes: Wf,
        ArrayPrototypeJoin: $f,
        ArrayPrototypeMap: Bw,
        NumberIsInteger: ws,
        NumberIsNaN: Mw,
        NumberMAX_SAFE_INTEGER: Nw,
        NumberMIN_SAFE_INTEGER: qw,
        NumberParseInt: Lw,
        ObjectPrototypeHasOwnProperty: Uw,
        RegExpPrototypeExec: Hf,
        String: Dw,
        StringPrototypeToUpperCase: jw,
        StringPrototypeTrim: Fw,
      } = Ee(),
      {
        hideStackFrames: et,
        codes: {
          ERR_SOCKET_BAD_PORT: Ww,
          ERR_INVALID_ARG_TYPE: je,
          ERR_INVALID_ARG_VALUE: Jr,
          ERR_OUT_OF_RANGE: vr,
          ERR_UNKNOWN_SIGNAL: Df,
        },
      } = De(),
      { normalizeEncoding: $w } = $e(),
      { isAsyncFunction: Hw, isArrayBufferView: Vw } = $e().types,
      jf = {};
    function Gw(t) {
      return t === (t | 0);
    }
    ...
    var Kw = /^[0-7]+$/,
      Qw = "must be a 32-bit unsigned integer or an octal string";
    function Yw(t, e, r) {
      if ((typeof t > "u" && (t = r), typeof t == "string")) {
        if (Hf(Kw, t) === null) throw new Jr(e, t, Qw);
        t = Lw(t, 8);
      }
      return (Vf(t, e), t);
    }
    ...
    var tm = et((t, e, r = null) => {
        let n = gs(r, "allowArray", !1),
          i = gs(r, "allowFunction", !1);
        if (
          (!gs(r, "nullable", !1) && t === null) ||
          (!n && bs(t)) ||
          (typeof t != "object" && (!i || typeof t != "function"))
        )
    ...
    function im(t, e) {
      qi(t, e);
      for (let r = 0; r < t.length; r++) Gf(t[r], `${e}[${r}]`);
    }
    function om(t, e) {
      qi(t, e);
    ...
    function sm(t, e = "signal") {
      if ((ms(t, e), jf[t] === void 0))
        throw jf[jw(t)] !== void 0
          ? new Df(t + " (signals must use all capital letters)")
          : new Df(t);
    }
    ...
    function um(t, e) {
      let r = $w(e),
        n = t.length;
      if (r === "hex" && n % 2 !== 0)
        throw new Jr("encoding", e, `is invalid for data of length ${n}`);
    }
    function lm(t, e = "Port", r = !0) {
      if (
        (typeof t != "number" && typeof t != "string") ||
        (typeof t == "string" && Fw(t).length === 0) ||
        +t !== +t >>> 0 ||
        t > 65535 ||
        (t === 0 && !r)
      )
    ...
    function dm(t, e, r) {
      if (!Wf(r, t)) throw new je(e, `('${$f(r, "|")}')`, t);
    }
    var pm = /^(?:<[^>]*>)(?:\s*;\s*[^;"\s]+(?:=(")?[^;"\s]*\1)?)*$/;
    function Ff(t, e) {
      if (typeof t > "u" || !Hf(pm, t))
        throw new Jr(
          e,
          t,
    ...
    function ym(t) {
      if (typeof t == "string") return (Ff(t, "hints"), t);
      if (bs(t)) {
        let e = t.length,
          r = "";
        if (e === 0) return r;
  ...
  var tr = j((_O, Xf) => {
    ...
    function bm() {
      !Zr ||
        !Sr ||
        ((Zr = !1),
        Sr.length ? (qt = Sr.concat(qt)) : (Li = -1),
        qt.length && Yf());
    }
    function Yf() {
      if (!Zr) {
    ...
    Te.nextTick = function (t) {
      ...
      if (arguments.length > 1)
        for (var r = 1; r < arguments.length; r++) e[r - 1] = arguments[r];
      (qt.push(new Jf(t, e)), qt.length === 1 && !Zr && Qf(Yf));
    };
    function Jf(t, e) {
      ((this.fun = t), (this.array = e));
    }
  ...
  var mt = j((TO, dh) => {
    ...
    x();
    I();
    var { SymbolAsyncIterator: Zf, SymbolIterator: eh, SymbolFor: Er } = Ee(),
      th = Er("nodejs.stream.destroyed"),
      rh = Er("nodejs.stream.errored"),
      Ss = Er("nodejs.stream.readable"),
      Es = Er("nodejs.stream.writable"),
      nh = Er("nodejs.stream.disturbed"),
      wm = Er("nodejs.webstream.isClosedPromise"),
      mm = Er("nodejs.webstream.controllerErrorFunction");
    function Ui(t, e = !1) {
      var r;
      return !!(
        t &&
    ...
    function vm(t) {
      return ih(t) || oh(t) || sh(t);
    }
    function Sm(t, e) {
      return t == null
        ? !1
        : e === !0
          ? typeof t[Zf] == "function"
          : e === !1
            ? typeof t[eh] == "function"
            : typeof t[Zf] == "function" || typeof t[eh] == "function";
    }
    function ji(t) {
      if (!wt(t)) return null;
      let e = t._writableState,
        r = t._readableState,
        n = e || r;
      return !!(t.destroyed || t[th] || (n != null && n.destroyed));
    }
    function ah(t) {
      if (!Di(t)) return null;
    ...
    function ch(t) {
      return t && t[Es] != null
        ...
        : typeof t?.writable != "boolean"
          ...
          : ji(t)
            ? !1
            : Di(t) && t.writable && !ah(t);
    }
    function Im(t, e) {
      return wt(t)
        ? ji(t)
          ? !0
          : !((e?.readable !== !1 && lh(t)) || (e?.writable !== !1 && ch(t)))
        : null;
    }
    function xm(t) {
      var e, r;
        ...
        ((e =
          (r =
            (n =
              (i =
                (s =
                  (o = t[rh]) !== null && o !== void 0
                    ? o
                    : t.readableErrored) !== null && s !== void 0
                  ? s
                  : t.writableErrored) !== null && i !== void 0
                ? i
                : (a = t._readableState) === null || a === void 0
                  ? void 0
                  : a.errorEmitted) !== null && n !== void 0
              ? n
              : (c = t._writableState) === null || c === void 0
                ? void 0
  ...
  var Ut = j((MO, Ps) => {
    ...
    I();
    var rr = tr(),
      { AbortError: Sh, codes: Bm } = De(),
      { ERR_INVALID_ARG_TYPE: Mm, ERR_STREAM_PREMATURE_CLOSE: ph } = Bm,
      { kEmptyObject: Is, once: xs } = $e(),
      {
        validateAbortSignal: Nm,
        validateFunction: qm,
        validateObject: Lm,
        validateBoolean: Um,
      } = Xr(),
      { Promise: Dm, PromisePrototypeThen: jm, SymbolDispose: Eh } = Ee(),
      {
        isClosed: Fm,
        isReadable: yh,
        isReadableNodeStream: As,
        isReadableStream: Wm,
        isReadableFinished: gh,
        isReadableErrored: bh,
        isWritable: wh,
        isWritableNodeStream: mh,
        isWritableStream: $m,
        isWritableFinished: _h,
        isWritableErrored: vh,
        isNodeStream: Hm,
        willEmitClose: Vm,
        kIsClosedPromise: Gm,
      } = mt(),
    ...
    function Ah(t, e, r) {
      ...
      let s = (n = e.readable) !== null && n !== void 0 ? n : As(t),
        o = (i = e.writable) !== null && i !== void 0 ? i : mh(t),
        a = t._writableState,
        c = t._readableState,
        f = () => {
          t.writable || m();
        },
        h = Vm(t) && As(t) === s && mh(t) === o,
        d = _h(t, !1),
        m = () => {
          ((d = !0),
            t.destroyed && (h = !1),
            !(h && (!t.readable || s)) && (!s || g) && r.call(t));
        },
        g = gh(t, !1),
        P = () => {
          ((g = !0),
            t.destroyed && (h = !1),
            !(h && (!t.writable || o)) && (!o || d) && r.call(t));
        },
        S = (y) => {
          r.call(t, y);
        },
        ...
        w = () => {
          ...
          if (s && !g && As(t, !0) && !gh(t, !1)) return r.call(t, new ph());
          if (o && !d && !_h(t, !1)) return r.call(t, new ph());
          r.call(t);
        },
        _ = () => {
          b = !0;
      ...
      (zm(t)
        ...
        : o && !a && (t.on("end", f), t.on("close", f)),
        !h && typeof t.aborted == "boolean" && t.on("aborted", w),
        t.on("end", P),
        t.on("finish", m),
        ...
        b
          ? rr.nextTick(w)
          : (a != null && a.errorEmitted) || (c != null && c.errorEmitted)
            ? h || rr.nextTick(_)
            : ((!s && (!h || yh(t)) && (d || wh(t) === !1)) ||
                (!o && (!h || wh(t)) && (g || yh(t) === !1)) ||
                (c && t.req && t.aborted)) &&
      ...
      let T = () => {
        ((r = Ts),
          t.removeListener("aborted", w),
          t.removeListener("complete", m),
          t.removeListener("abort", w),
      ...
      if (e.signal && !b) {
        let y = () => {
          let O = r;
          (T(), O.call(t, new Sh(void 0, { cause: e.signal.reason })));
        };
    ...
    function Km(t, e, r) {
      ...
      if (e.signal)
        if (
          ((i = () => {
            ((n = !0), r.call(t, new Sh(void 0, { cause: e.signal.reason })));
          }),
          e.signal.aborted)
        )
          rr.nextTick(i);
    ...
    function Qm(t, e) {
      ...
      return (
        ...
        (r = e) !== null &&
          r !== void 0 &&
          r.cleanup &&
          (Um(e.cleanup, "cleanup"), (n = e.cleanup)),
        new Dm((i, s) => {
          let o = Ah(t, e, (a) => {
            (n && o(), a ? s(a) : i());
          });
  ...
  var Ar = j((FO, Ch) => {
    ...
    var _t = tr(),
      {
        aggregateTwoErrors: Ym,
        codes: { ERR_MULTIPLE_CALLBACK: Jm },
        AbortError: Xm,
      } = De(),
      { Symbol: Th } = Ee(),
      {
    ...
    function Ih(t, e, r) {
      ...
      function i(s) {
        ...
        (Oh(s, a, o),
          ...
          s ? _t.nextTick(i_, t, s) : _t.nextTick(Rh, t));
      }
      try {
        t._destroy(e || null, i);
      } catch (s) {
    ...
    function s_(t, e) {
      ...
      (r && (r.constructed = !1),
        n && (n.constructed = !1),
        t.once(Os, e),
        !(t.listenerCount(Os) > 1) && _t.nextTick(a_, t));
    }
    function a_(t) {
      let e = !1;
      function r(n) {
        ...
        (i && (i.constructed = !0),
          s && (s.constructed = !0),
          o.destroyed ? t.emit(Ph, n) : n ? ks(t, n, !0) : _t.nextTick(u_, t));
      }
      try {
        t._construct((n) => {
          _t.nextTick(r, n);
    ...
    function l_(t, e) {
      (t.emit("error", e), _t.nextTick(kh, t));
    }
    function c_(t, e) {
      !t ||
        e_(t) ||
  ...
  var $i = j((KO, Mh) => {
    ...
    x();
    I();
    var { ArrayIsArray: f_, ObjectSetPrototypeOf: Bh } = Ee(),
      { EventEmitter: Fi } = (er(), me(Zt));
    function Wi(t) {
      Fi.call(this, t);
    }
    Bh(Wi.prototype, Fi.prototype);
    Bh(Wi, Fi);
    ...
    Mh.exports = { Stream: Wi, prependListener: Cs };
  });
  var kn = j((tR, Hi) => {
    "use strict";
    A();
    x();
    I();
    var { SymbolDispose: h_ } = Ee(),
      { AbortError: Nh, codes: d_ } = De(),
      {
        isNodeStream: qh,
        isWebStream: p_,
        kControllerErrorFunction: y_,
      } = mt(),
      g_ = Ut(),
      { ERR_INVALID_ARG_TYPE: Lh } = d_,
      Bs,
      b_ = (t, e) => {
        if (typeof t != "object" || !("aborted" in t))
          throw new Lh(e, "AbortSignal", t);
      };
    Hi.exports.addAbortSignal = function (e, r) {
      if ((b_(e, "signal"), !qh(r) && !p_(r)))
        throw new Lh(
          "stream",
          ["ReadableStream", "WritableStream", "Stream"],
          r,
    ...
    Hi.exports.addAbortSignalNoValidate = function (t, e) {
      ...
      let r = qh(e)
        ? () => {
            e.destroy(new Nh(void 0, { cause: t.reason }));
          }
        : () => {
            e[y_](new Nh(void 0, { cause: t.reason }));
          };
      if (t.aborted) r();
      else {
  ...
  var jh = j((lR, Dh) => {
    ...
    I();
    var {
        StringPrototypeSlice: Uh,
        SymbolIterator: w_,
        TypedArrayPrototypeSet: Vi,
        Uint8Array: m_,
      } = Ee(),
      { Buffer: Ms } = (ke(), me(qe)),
      { inspect: __ } = $e();
    Dh.exports = class {
      ...
      *[w_]() {
        ...
        do {
          ...
          if (e > s.length) ((r += s), (e -= s.length));
            ...
            e === s.length
              ...
              : ((r += Uh(s, 0, e)), (this.head = n), (n.data = Uh(s, e)));
            break;
          }
          ++i;
        } while ((n = n.next) !== null);
        ...
        do {
          ...
          if (e > o.length) (Vi(r, o, n - e), (e -= o.length));
            ...
            e === o.length
              ...
              : (Vi(r, new m_(o.buffer, o.byteOffset, e), n - e),
                (this.head = i),
                (i.data = o.slice(e)));
            break;
          }
      ...
      [Symbol.for("nodejs.util.inspect.custom")](e, r) {
        return __(this, { ...r, depth: 0, customInspect: !1 });
      }
    };
  });
  var Cn = j((gR, Hh) => {
    ...
    x();
    I();
    var { MathFloor: v_, NumberIsInteger: S_ } = Ee(),
      { validateInteger: E_ } = Xr(),
      { ERR_INVALID_ARG_VALUE: A_ } = De().codes,
      Fh = 16 * 1024,
      Wh = 16;
    function I_(t, e, r) {
    ...
    function T_(t, e, r, n) {
      ...
      return $h(t.objectMode);
    }
    Hh.exports = {
      getHighWaterMark: T_,
      getDefaultHighWaterMark: $h,
  ...
  var zh = j((Ns, Gh) => {
    ...
    vt.from && vt.alloc && vt.allocUnsafe && vt.allocUnsafeSlow
      ? (Gh.exports = Gi)
      : (Vh(Gi, Ns), (Ns.Buffer = Ir));
    function Ir(t, e, r) {
      return vt(t, e, r);
    }
  ...
  var Yh = j((Qh) => {
    ...
    function O_(t) {
      var e = P_(t);
      if (typeof e != "string" && (Ls.isEncoding === Kh || !Kh(t)))
    ...
    function Bn(t) {
      ...
      ((this.lastNeed = 0),
        (this.lastTotal = 0),
        (this.lastChar = Ls.allocUnsafe(e)));
    }
  ...
  var Us = j((qR, ed) => {
    ...
    var Jh = tr(),
      {
        PromisePrototypeThen: F_,
        SymbolAsyncIterator: Xh,
        SymbolIterator: Zh,
      } = Ee(),
      { Buffer: W_ } = (ke(), me(qe)),
      { ERR_INVALID_ARG_TYPE: $_, ERR_STREAM_NULL_VALUES: H_ } = De().codes;
    function V_(t, e, r) {
      let n;
      if (typeof e == "string" || e instanceof W_)
        return new t({
          objectMode: !0,
          ...r,
          read() {
      ...
      let i;
      if (e && e[Xh]) ((i = !0), (n = e[Xh]()));
      else if (e && e[Zh]) ((i = !1), (n = e[Zh]()));
      else throw new $_("iterable", ["Iterable"], e);
      let s = new t({ objectMode: !0, highWaterMark: 1, ...r }),
        o = !1;
      ((s._read = function () {
        o || ((o = !0), c());
      }),
  ...
  var Nn = j(($R, wd) => {
    ...
    var lt = tr(),
      {
        ArrayPrototypeIndexOf: G_,
        NumberIsInteger: z_,
        NumberIsNaN: K_,
        NumberParseInt: Q_,
        ObjectDefineProperties: Gs,
        ObjectKeys: Y_,
        ObjectSetPrototypeOf: nd,
        Promise: id,
        SafeSet: J_,
        SymbolAsyncDispose: X_,
        SymbolAsyncIterator: Z_,
        Symbol: ev,
      } = Ee();
    wd.exports = le;
    le.ReadableState = Yi;
    var { EventEmitter: tv } = (er(), me(Zt)),
      { Stream: nr, prependListener: rv } = $i(),
      { Buffer: Ds } = (ke(), me(qe)),
      { addAbortSignal: nv } = kn(),
      od = Ut(),
      de = $e().debuglog("stream", (t) => {
        de = t;
      }),
      iv = jh(),
      nn = Ar(),
      { getHighWaterMark: ov, getDefaultHighWaterMark: sv } = Cn(),
      {
        aggregateTwoErrors: td,
        codes: {
          ERR_INVALID_ARG_TYPE: av,
          ERR_METHOD_NOT_IMPLEMENTED: uv,
          ERR_OUT_OF_RANGE: lv,
          ERR_STREAM_PUSH_AFTER_EOF: cv,
          ERR_STREAM_UNSHIFT_AFTER_END_EVENT: fv,
        },
        AbortError: hv,
      } = De(),
      { validateObject: dv } = Xr(),
      xr = ev("kPaused"),
      { StringDecoder: sd } = Yh(),
      pv = Us();
    nd(le.prototype, nr.prototype);
    nd(le, nr);
    var js = () => {},
      { errorOrDestroy: tn } = nn,
      rn = 1,
      yv = 2,
      ad = 4,
      Mn = 8,
    ...
    Gs(Yi.prototype, {
      ...
      closed: Ce(_v),
      closeEmitted: Ce(vv),
      multiAwaitDrain: Ce(cd),
      readingMore: Ce(Sv),
      dataEmitted: Ce(Ev),
    });
    function Yi(t, e, r) {
      (typeof r != "boolean" && (r = e instanceof St()),
        (this.state = Hs | Vs | ud | zi),
        t && t.objectMode && (this.state |= rn),
        r && t && t.readableObjectMode && (this.state |= rn),
        (this.highWaterMark = t
          ? ov(this, t, "readableHighWaterMark", r)
          : sv(!1)),
        (this.buffer = new iv()),
        (this.length = 0),
        (this.pipes = []),
        (this.flowing = null),
        (this[xr] = null),
        t && t.emitClose === !1 && (this.state &= ~Hs),
        t && t.autoDestroy === !1 && (this.state &= ~Vs),
        (this.errored = null),
        ...
        t &&
          t.encoding &&
          ((this.decoder = new sd(t.encoding)), (this.encoding = t.encoding)));
    }
    function le(t) {
      if (!(this instanceof le)) return new le(t);
      let e = this instanceof St();
      ((this._readableState = new Yi(t, this, e)),
        t &&
    ...
    le.prototype[X_] = function () {
      ...
      return (
        this.destroyed ||
          ((t = this.readableEnded ? null : new hv()), this.destroy(t)),
        new id((e, r) => od(this, (n) => (n && n !== t ? r(n) : e(null))))
      );
    };
        ...
        ((i.state & rn) === 0 &&
          (typeof e == "string"
            ? ((r = r || i.defaultEncoding),
              i.encoding !== r &&
                (n && i.encoding
                  ? (e = Ds.from(e, r).toString(i.encoding))
                  : ((e = Ds.from(e, r)), (r = ""))))
            : e instanceof Ds
              ? (r = "")
              : nr._isUint8Array(e)
                ? ((e = nr._uint8ArrayToBuffer(e)), (r = ""))
                : e != null &&
                  (s = new av("chunk", ["string", "Buffer", "Uint8Array"], e))),
        s)
      )
        tn(t, s);
      else if (e === null) ((i.state &= ~Mn), xv(t, i));
      else if ((i.state & rn) !== 0 || (e && e.length > 0))
        if (n)
          if ((i.state & ad) !== 0) tn(t, new fv());
          else {
          ...
          ((i.state &= ~Mn),
            i.decoder && !r
              ? ((e = i.decoder.write(e)),
                i.objectMode || e.length !== 0 ? Fs(t, i, e, !1) : Qi(t, i))
              : Fs(t, i, e, !1));
        }
    ...
    le.prototype.read = function (t) {
      ...
      let e = this._readableState,
        r = t;
      if (
        (t > e.highWaterMark && (e.highWaterMark = Iv(t)),
        t !== 0 && (e.state &= ~ld),
        t === 0 &&
          e.needReadable &&
          ((e.highWaterMark !== 0
        ...
        return (
          de("read: emitReadable", e.length, e.ended),
          e.length === 0 && e.ended ? Ws(this) : Ji(this),
          null
        );
      if (((t = rd(t, e)), t === 0 && e.ended))
        return (e.length === 0 && Ws(this), null);
      let n = (e.state & Ki) !== 0;
      if (
        (de("need readable", n),
        (e.length === 0 || e.length - t < e.highWaterMark) &&
          ((n = !0), de("length less than watermark", n)),
        e.ended || e.reading || e.destroyed || e.errored || !e.constructed)
      )
        ((n = !1), de("reading, ended or constructing", n));
      else if (n) {
        (de("do read"),
          (e.state |= Mn | zi),
          e.length === 0 && (e.state |= Ki));
        try {
          this._read(e.highWaterMark);
        } catch (s) {
          tn(this, s);
        }
        ((e.state &= ~zi), e.reading || (t = rd(r, e)));
      }
      let i;
      return (
        t > 0 ? (i = gd(t, e)) : (i = null),
        i === null
          ...
          : ((e.length -= t),
            e.multiAwaitDrain
              ...
              : (e.awaitDrainWriters = null)),
        e.length === 0 &&
          (e.ended || (e.needReadable = !0), r !== t && e.ended && Ws(this)),
        i !== null &&
          !e.errorEmitted &&
          !e.closeEmitted &&
          ((e.dataEmitted = !0), this.emit("data", i)),
        i
      );
    };
    function xv(t, e) {
      if ((de("onEofChunk"), !e.ended)) {
        ...
        ((e.ended = !0),
          e.sync
            ? Ji(t)
            : ((e.needReadable = !1), (e.emittedReadable = !0), hd(t)));
      }
    }
    function Ji(t) {
      let e = t._readableState;
      (de("emitReadable", e.needReadable, e.emittedReadable),
        (e.needReadable = !1),
        e.emittedReadable ||
          (de("emitReadable", e.flowing),
          (e.emittedReadable = !0),
          lt.nextTick(hd, t)));
    }
    function hd(t) {
      let e = t._readableState;
      (de("emitReadable_", e.destroyed, e.length, e.ended),
        !e.destroyed &&
          !e.errored &&
          (e.length || e.ended) &&
    ...
    function Qi(t, e) {
      !e.readingMore &&
        e.constructed &&
        ((e.readingMore = !0), lt.nextTick(Tv, t, e));
    }
    function Tv(t, e) {
      for (
        ;
    ...
    le.prototype.pipe = function (t, e) {
      ...
      (n.pipes.length === 1 &&
        (n.multiAwaitDrain ||
          ((n.multiAwaitDrain = !0),
          (n.awaitDrainWriters = new J_(
            n.awaitDrainWriters ? [n.awaitDrainWriters] : [],
          )))),
        n.pipes.push(t),
        de("pipe count=%d opts=%j", n.pipes.length, e));
      let s =
        (!e || e.end !== !1) && t !== lt.stdout && t !== lt.stderr ? a : b;
      (n.endEmitted ? lt.nextTick(s) : r.once("end", s), t.on("unpipe", o));
      function o(w, _) {
        (de("onunpipe"),
          w === r && _ && _.hasUnpiped === !1 && ((_.hasUnpiped = !0), h()));
      }
      function a() {
        (de("onend"), t.end());
      }
      ...
      function d() {
        (f ||
          (n.pipes.length === 1 && n.pipes[0] === t
            ? (de("false write response, pause", 0),
              (n.awaitDrainWriters = t),
              (n.multiAwaitDrain = !1))
            : n.pipes.length > 1 &&
              n.pipes.includes(t) &&
              (de("false write response, pause", n.awaitDrainWriters.size),
              n.awaitDrainWriters.add(t)),
          r.pause()),
          c || ((c = Pv(r, t)), t.on("drain", c)));
      }
      r.on("data", m);
      function m(w) {
        de("ondata");
      ...
      return (
        ...
        t.writableNeedDrain === !0
          ? d()
          : n.flowing || (de("pipe resume"), r.resume()),
        t
      );
    };
    function Pv(t, e) {
      return function () {
        ...
        (n.awaitDrainWriters === e
          ? (de("pipeOnDrain", 1), (n.awaitDrainWriters = null))
          : n.multiAwaitDrain &&
            (de("pipeOnDrain", n.awaitDrainWriters.size),
    ...
    le.prototype.on = function (t, e) {
      let r = nr.prototype.on.call(this, t, e),
        n = this._readableState;
      return (
        t === "data"
          ...
          : t === "readable" &&
            ...
            (n.flowing = !1),
            (n.emittedReadable = !1),
            de("on readable", n.length, n.reading),
            n.length ? Ji(this) : n.reading || lt.nextTick(Ov, this)),
        r
      );
    };
    ...
    le.prototype.removeListener = function (t, e) {
      ...
      return (t === "readable" && lt.nextTick(dd, this), r);
    };
    ...
    le.prototype.removeAllListeners = function (t) {
      ...
      return ((t === "readable" || t === void 0) && lt.nextTick(dd, this), e);
    };
    function dd(t) {
      let e = t._readableState;
      ((e.readableListening = t.listenerCount("readable") > 0),
        e.resumeScheduled && e[xr] === !1
          ? (e.flowing = !0)
    ...
    le.prototype.resume = function () {
      ...
      return (
        t.flowing ||
          (de("resume"), (t.flowing = !t.readableListening), Rv(this, t)),
        (t[xr] = !1),
        this
      );
    };
    ...
    le.prototype.iterator = function (t) {
      return (t !== void 0 && dv(t, "options"), yd(this, t));
    };
    function yd(t, e) {
    ...
    async function* Cv(t, e) {
      ...
      try {
        ...
        (i || e?.destroyOnReturn !== !1) &&
        (i === void 0 || t._readableState.autoDestroy)
          ? nn.destroyer(t, null)
          : (t.off("readable", n), s());
      }
    }
    ...
    function Ws(t) {
      let e = t._readableState;
      (de("endReadable", e.endEmitted),
        e.endEmitted || ((e.ended = !0), lt.nextTick(Bv, e, t)));
    }
    function Bv(t, e) {
      if (
        (de("endReadableNT", t.endEmitted, t.length),
    ...
    le.fromWeb = function (t, e) {
      return bd().newStreamReadableFromReadableStream(t, e);
    };
    le.toWeb = function (t, e) {
      return bd().newReadableStreamFromStreamReadable(t, e);
    };
  ...
  var ro = j((YR, Rd) => {
    ...
    var Tr = tr(),
      {
        ArrayPrototypeSlice: vd,
        Error: Nv,
        FunctionPrototypeSymbolHasInstance: Sd,
        ObjectDefineProperty: Ed,
        ObjectDefineProperties: qv,
        ObjectSetPrototypeOf: Ad,
        StringPrototypeToLowerCase: Lv,
        Symbol: Uv,
        SymbolHasInstance: Dv,
      } = Ee();
    Rd.exports = Ie;
    Ie.WritableState = Un;
    var { EventEmitter: jv } = (er(), me(Zt)),
      qn = $i().Stream,
      { Buffer: Xi } = (ke(), me(qe)),
      to = Ar(),
      { addAbortSignal: Fv } = kn(),
      { getHighWaterMark: Wv, getDefaultHighWaterMark: $v } = Cn(),
      {
        ERR_INVALID_ARG_TYPE: Hv,
        ERR_METHOD_NOT_IMPLEMENTED: Vv,
        ERR_MULTIPLE_CALLBACK: Id,
        ERR_STREAM_CANNOT_PIPE: Gv,
        ERR_STREAM_DESTROYED: Ln,
        ERR_STREAM_ALREADY_FINISHED: zv,
        ERR_STREAM_NULL_VALUES: Kv,
        ERR_STREAM_WRITE_AFTER_END: Qv,
        ERR_UNKNOWN_ENCODING: xd,
      } = De().codes,
      { errorOrDestroy: on } = to;
    Ad(Ie.prototype, qn.prototype);
    Ad(Ie, qn);
    function Qs() {}
    ...
    function Un(t, e, r) {
      (typeof r != "boolean" && (r = e instanceof St()),
        ...
        (this.highWaterMark = t
          ? Wv(this, t, "writableHighWaterMark", r)
          : $v(!1)),
        (this.finalCalled = !1),
        (this.needDrain = !1),
        (this.ending = !1),
    ...
    Un.prototype.getBuffer = function () {
      return vd(this.buffered, this.bufferedIndex);
    };
    Ed(Un.prototype, "bufferedRequestCount", {
      __proto__: null,
      get() {
    ...
    function Ie(t) {
      let e = this instanceof St();
      if (!e && !Sd(Ie, this)) return new Ie(t);
      ((this._writableState = new Un(t, this, e)),
        t &&
    ...
    Ed(Ie, Dv, {
      ...
      value: function (t) {
        return Sd(this, t)
          ...
          : this !== Ie
            ? !1
            : t && t._writableState instanceof Un;
      },
    });
    ...
    function Td(t, e, r, n) {
      ...
      if (typeof r == "function") ((n = r), (r = i.defaultEncoding));
        ...
        else if (r !== "buffer" && !Xi.isEncoding(r)) throw new xd(r);
        typeof n != "function" && (n = Qs);
      }
      if (e === null) throw new Kv();
      if (!i.objectMode)
        if (typeof e == "string")
          i.decodeStrings !== !1 && ((e = Xi.from(e, r)), (r = "buffer"));
        else if (e instanceof Xi) r = "buffer";
        else if (qn._isUint8Array(e))
          ((e = qn._uint8ArrayToBuffer(e)), (r = "buffer"));
        else throw new Hv("chunk", ["string", "Buffer", "Uint8Array"], e);
      let s;
      return (
        i.ending ? (s = new Qv()) : i.destroyed && (s = new Ln("write")),
        s
          ? (Tr.nextTick(n, s), on(t, s, !0), s)
          : (i.pendingcb++, Yv(t, i, e, r, n))
      );
    }
    Ie.prototype.write = function (t, e, r) {
      return Td(this, t, e, r) === !0;
    };
    ...
    Ie.prototype.setDefaultEncoding = function (e) {
      if ((typeof e == "string" && (e = Lv(e)), !Xi.isEncoding(e)))
        throw new xd(e);
    ...
    function Yv(t, e, r, n, i) {
      ...
      return (
        ...
        e.writing || e.corked || e.errored || !e.constructed
          ? (e.buffered.push({ chunk: r, encoding: n, callback: i }),
            e.allBuffers && n !== "buffer" && (e.allBuffers = !1),
            e.allNoop && i !== Qs && (e.allNoop = !1))
          : ((e.writelen = s),
            (e.writecb = i),
            (e.writing = !0),
            (e.sync = !0),
            t._write(r, n, e.onwrite),
            (e.sync = !1)),
        o && !e.errored && !e.destroyed
      );
    }
    function md(t, e, r, n, i, s, o) {
      ((e.writelen = n),
        (e.writecb = o),
        (e.writing = !0),
        (e.sync = !0),
        e.destroyed
          ? e.onwrite(new Ln("write"))
          : r
      ...
      ((r.writing = !1),
        ...
        e
          ? (e.stack,
            ...
            n ? Tr.nextTick(_d, t, r, e, i) : _d(t, r, e, i))
          : (r.buffered.length > r.bufferedIndex && Js(t, r),
            n
              ? r.afterWriteTickInfo !== null && r.afterWriteTickInfo.cb === i
                ...
                : ((r.afterWriteTickInfo = {
                  ...
                  Tr.nextTick(Xv, r.afterWriteTickInfo))
              : Pd(t, r, 1, i)));
    }
    function Xv({ stream: t, state: e, count: r, cb: n }) {
      return ((e.afterWriteTickInfo = null), Pd(t, e, r, n));
    }
    function Pd(t, e, r, n) {
      for (
        !e.ending &&
    ...
    function Ys(t) {
      ...
      for (let i = t.bufferedIndex; i < t.buffered.length; ++i) {
        var e;
        let { chunk: s, callback: o } = t.buffered[i],
          a = t.objectMode ? 1 : s.length;
        ((t.length -= a),
          o((e = t.errored) !== null && e !== void 0 ? e : new Ln("write")));
      }
      let r = t[sn].splice(0);
    ...
    function Js(t, e) {
      if (e.corked || e.bufferProcessing || e.destroyed || !e.constructed)
        return;
      let { buffered: r, bufferedIndex: n, objectMode: i } = e,
        s = r.length - n;
      if (!s) return;
      let o = n;
      if (((e.bufferProcessing = !0), s > 1 && t._writev)) {
        ...
        let a = e.allNoop
          ...
          c = e.allNoop && o === 0 ? r : vd(r, o);
        ((c.allBuffers = e.allBuffers),
          md(t, e, !0, e.length, c, "", a),
          eo(e));
      } else {
        do {
        ...
        o === r.length
          ? eo(e)
          : o > 256
            ? (r.splice(0, o), (e.bufferedIndex = 0))
            : (e.bufferedIndex = o);
      }
    ...
    Ie.prototype.end = function (t, e, r) {
      ...
      return (
        ...
        i ||
          (!n.errored && !n.ending
            ? ((n.ending = !0), Xs(this, n, !0), (n.ended = !0))
            : n.finished
              ? (i = new zv("end"))
              : n.destroyed && (i = new Ln("end"))),
        typeof r == "function" &&
          (i || n.finished ? Tr.nextTick(r, i) : n[sn].push(r)),
        this
      );
    };
    function Zi(t) {
    ...
    Ie.prototype.destroy = function (t, e) {
      ...
      return (
        !r.destroyed &&
          (r.bufferedIndex < r.buffered.length || r[sn].length) &&
          Tr.nextTick(Ys, r),
        t0.call(this, t, e),
        this
      );
    ...
    Ie.fromWeb = function (t, e) {
      return Od().newStreamWritableFromWritableStream(t, e);
    };
    Ie.toWeb = function (t) {
      return Od().newWritableStreamFromStreamWritable(t);
    };
  });
  var Vd = j((nk, Hd) => {
    A();
    ...
    var Zs = tr(),
      r0 = (ke(), me(qe)),
      {
        ...
        isIterable: kd,
        isNodeStream: o0,
        isReadableNodeStream: Cd,
        isWritableNodeStream: Bd,
        isDuplexNodeStream: s0,
        isReadableStream: Md,
        isWritableStream: Nd,
      } = mt(),
      qd = Ut(),
      {
        AbortError: Wd,
        codes: { ERR_INVALID_ARG_TYPE: a0, ERR_INVALID_RETURN_VALUE: Ld },
      } = De(),
      { destroyer: un } = Ar(),
      u0 = St(),
      $d = Nn(),
      l0 = ro(),
      { createDeferredPromise: Ud } = $e(),
      Dd = Us(),
      jd = globalThis.Blob || r0.Blob,
      c0 =
        typeof jd < "u"
          ? function (e) {
      ...
      f0 = globalThis.AbortController || Yr().AbortController,
      { FunctionPrototypeCall: Fd } = Ee(),
      ir = class extends u0 {
        constructor(e) {
          (super(e),
            e?.readable === !1 &&
    ...
    Hd.exports = function t(e, r) {
      if (s0(e)) return e;
      if (Cd(e)) return an({ readable: e });
      if (Bd(e)) return an({ writable: e });
      if (o0(e)) return an({ writable: !1, readable: !1 });
      if (Md(e)) return an({ readable: $d.fromWeb(e) });
      if (Nd(e)) return an({ writable: l0.fromWeb(e) });
      if (typeof e == "function") {
        let { value: i, write: s, final: o, destroy: a } = h0(e);
        if (kd(i))
          return Dd(ir, i, { objectMode: !0, write: s, final: o, destroy: a });
        let c = i?.then;
        if (typeof c == "function") {
          let f,
            h = Fd(
              ...
              i,
              (d) => {
                if (d != null) throw new Ld("nully", "body", d);
              },
              (d) => {
                un(f, d);
              },
        ...
        throw new Ld("Iterable, AsyncIterable or AsyncFunction", r, i);
      }
      if (c0(e)) return t(e.arrayBuffer());
      if (kd(e)) return Dd(ir, e, { objectMode: !0, writable: !1 });
      if (Md(e?.readable) && Nd(e?.writable)) return ir.fromWeb(e);
      ...
      if (typeof n == "function") {
        ...
        return (
          ...
          (i = new ir({ objectMode: !0, writable: !1, read() {} }))
        );
      }
      throw new a0(
        r,
    ...
    function h0(t) {
      ...
      return {
        value: t(
          (async function* () {
            for (;;) {
              ...
              if (i.aborted) throw new Wd(void 0, { cause: i.reason });
              (({ promise: e, resolve: r } = Ud()), yield a);
            }
          })(),
          { signal: i },
        ),
        write(o, a, c) {
          let f = r;
          ((r = null), f({ chunk: o, done: !1, cb: c }));
        },
        final(o) {
          let a = r;
          ((r = null), a({ done: !0, cb: o }));
        },
        destroy(o, a) {
          (n.abort(), a(o));
        },
  ...
  var St = j((ck, Kd) => {
    ...
    I();
    var {
      ObjectDefineProperties: d0,
      ObjectGetOwnPropertyDescriptor: Dt,
      ObjectKeys: p0,
      ObjectSetPrototypeOf: Gd,
    } = Ee();
    Kd.exports = ct;
    var ra = Nn(),
      tt = ro();
    Gd(ct.prototype, ra.prototype);
    Gd(ct, ra);
    {
    ...
    d0(ct.prototype, {
      writable: { __proto__: null, ...Dt(tt.prototype, "writable") },
      writableHighWaterMark: {
        __proto__: null,
      ...
      writableEnded: { __proto__: null, ...Dt(tt.prototype, "writableEnded") },
      writableNeedDrain: {
        __proto__: null,
    ...
    ct.fromWeb = function (t, e) {
      return zd().newStreamDuplexFromReadableWritablePair(t, e);
    };
    ct.toWeb = function (t) {
      return zd().newReadableWritablePairFromDuplex(t);
    };
    var ta;
    ct.from = function (t) {
      return (ta || (ta = Vd()), ta(t, "body"));
    };
  });
  var oa = j((bk, Yd) => {
    "use strict";
    ...
    x();
    I();
    var { ObjectSetPrototypeOf: Qd, Symbol: y0 } = Ee();
    Yd.exports = jt;
    var { ERR_METHOD_NOT_IMPLEMENTED: g0 } = De().codes,
      ia = St(),
      { getHighWaterMark: b0 } = Cn();
    Qd(jt.prototype, ia.prototype);
    Qd(jt, ia);
    var Dn = y0("kCallback");
    function jt(t) {
    ...
    jt.prototype._write = function (t, e, r) {
      ...
      this._transform(t, e, (o, a) => {
        ...
        (a != null && this.push(a),
          i.ended || s === n.length || n.length < n.highWaterMark
            ? r()
            : (this[Dn] = r));
      });
    };
  ...
  var aa = j((Ak, Xd) => {
    ...
    x();
    I();
    var { ObjectSetPrototypeOf: Jd } = Ee();
    Xd.exports = ln;
    var sa = oa();
    Jd(ln.prototype, sa.prototype);
    Jd(ln, sa);
    function ln(t) {
  ...
  var so = j((kk, np) => {
    ...
    var jn = tr(),
      ...
      Zd = St(),
      {
        aggregateTwoErrors: I0,
        codes: {
          ERR_INVALID_ARG_TYPE: ga,
          ERR_INVALID_RETURN_VALUE: ua,
          ERR_MISSING_ARGS: x0,
          ERR_STREAM_DESTROYED: T0,
          ERR_STREAM_PREMATURE_CLOSE: P0,
        },
        AbortError: O0,
      } = De(),
      { validateFunction: R0, validateAbortSignal: k0 } = Xr(),
      {
        isIterable: Pr,
        isReadable: la,
        isReadableNodeStream: io,
        isNodeStream: ep,
        isTransformStream: cn,
        isWebStream: C0,
        isReadableStream: ca,
        isReadableFinished: B0,
      } = mt(),
      M0 = globalThis.AbortController || Yr().AbortController,
      fa,
      ha,
      da;
    function tp(t, e, r) {
    ...
    function rp(t, e, r) {
      if ((t.length === 1 && m0(t[0]) && (t = t[0]), t.length < 2))
        throw new x0("streams");
      let n = new M0(),
        i = n.signal,
        s = r?.signal,
        o = [];
      ...
      function P(R, T) {
        var y;
        if (
          (R && (!f || f.code === "ERR_STREAM_PREMATURE_CLOSE") && (f = R),
          !(!f && !T))
        ) {
          for (; d.length;) d.shift()(f);
          ((y = c) === null || y === void 0 || y[S0](),
            n.abort(),
            T && (f || o.forEach((O) => O()), jn.nextTick(e, f, h)));
        }
      }
      let S;
      for (let R = 0; R < t.length; R++) {
        ...
        if (ep(T)) {
          let F = function (U) {
            U &&
              U.name !== "AbortError" &&
              U.code !== "ERR_STREAM_PREMATURE_CLOSE" &&
              g(U);
          };
          var _ = F;
          if (v) {
            let { destroy: U, cleanup: Q } = tp(T, y, O);
        ...
        if (R === 0)
          if (typeof T == "function") {
            if (((S = T({ signal: i })), !Pr(S)))
              throw new ua("Iterable, AsyncIterable or Stream", "source", S);
          } else Pr(T) || io(T) || cn(T) ? (S = T) : (S = Zd.from(T));
          ...
          if (((S = T(S, { signal: i })), y)) {
            if (!Pr(S, !0))
              throw new ua("AsyncIterable", `transform[${R - 1}]`, S);
          } else {
            var w;
            fa || (fa = aa());
            let F = new fa({ objectMode: !0 }),
              U = (w = S) === null || w === void 0 ? void 0 : w.then;
            ...
            S = F;
            let { destroy: Q, cleanup: W } = tp(S, !1, !0);
            (d.push(Q), M && o.push(W));
          }
        } else if (ep(T)) {
          if (io(S)) {
    ...
    function U0(t, e, r, { end: n }) {
      ...
      return (
        ...
        oo(e, { readable: !1, writable: !0 }, r)
      );
    }
    np.exports = { pipelineImpl: rp, pipeline: L0 };
  });
  var wa = j((Uk, lp) => {
    "use strict";
    A();
    ...
    var { pipeline: D0 } = so(),
      ...
      {
        AbortError: F0,
        codes: { ERR_INVALID_ARG_VALUE: up, ERR_MISSING_ARGS: W0 },
      } = De(),
      $0 = Ut();
    lp.exports = function (...e) {
      ...
      let r = [...e];
      if (
        (typeof e[0] == "function" && (e[0] = ao.from(e[0])),
      ...
      for (let g = 0; g < e.length; ++g)
        if (!(!uo(e[g]) && !ba(e[g]))) {
          if (g < e.length - 1 && !(ip(e[g]) || ap(e[g]) || Or(e[g])))
            throw new up(`streams[${g}]`, r[g], "must be readable");
          if (g > 0 && !(op(e[g]) || sp(e[g]) || Or(e[g])))
            throw new up(`streams[${g}]`, r[g], "must be writable");
        }
      let n, i, s, o, a;
      function c(g) {
        let P = o;
      ...
      return (
        (a._destroy = function (g, P) {
          (!g && o !== null && (g = new F0()),
            (s = null),
            (n = null),
            (i = null),
            o === null ? P(g) : ((o = P), uo(h) && j0(h, g)));
        }),
        a
      );
    };
  ...
  var mp = j((Vk, va) => {
    ...
    x();
    I();
    var H0 = globalThis.AbortController || Yr().AbortController,
      {
        codes: {
          ERR_INVALID_ARG_VALUE: V0,
      ...
      {
        validateAbortSignal: Rr,
        validateInteger: cp,
        validateObject: kr,
      } = Xr(),
      K0 = Ee().Symbol("kWeak"),
      Q0 = Ee().Symbol("kResistStopPropagation"),
      { finished: Y0 } = Ut(),
      J0 = wa(),
      { addAbortSignalNoValidate: X0 } = kn(),
      { isWritable: Z0, isNodeStream: eS } = mt(),
      { deprecate: tS } = $e(),
      {
        ArrayPrototypePush: rS,
        Boolean: nS,
        MathFloor: fp,
        Number: iS,
        NumberIsNaN: oS,
    ...
    function aS(t, e) {
      if (
        (e != null && kr(e, "options"),
        e?.signal != null && Rr(e.signal, "options.signal"),
        eS(t) && !Z0(t))
      )
        throw new V0("stream", t, "must be writable");
      let r = J0(this, t);
      return (e != null && e.signal && X0(e.signal, r), r);
    }
    function co(t, e) {
      if (typeof t != "function")
        throw new Fn("fn", ["Function", "AsyncFunction"], t);
      (e != null && kr(e, "options"),
        e?.signal != null && Rr(e.signal, "options.signal"));
      let r = 1;
      e?.concurrency != null && (r = fp(e.concurrency));
      let n = r - 1;
      return (
        e?.highWaterMark != null && (n = fp(e.highWaterMark)),
        cp(r, "options.concurrency", 1),
        cp(n, "options.highWaterMark", 0),
        (n += r),
        async function* () {
          let s = $e().AbortSignalAny([e?.signal].filter(nS)),
            o = this,
            a = [],
            c = { signal: s },
            f,
    ...
    function uS(t = void 0) {
      return (
        t != null && kr(t, "options"),
        t?.signal != null && Rr(t.signal, "options.signal"),
        async function* () {
          let r = 0;
          for await (let i of this) {
            ...
            if (
              ...
              throw new Et({ cause: t.signal.reason });
            yield [r++, i];
          }
        }.call(this)
      );
    }
    async function bp(t, e = void 0) {
    ...
    async function lS(t, e = void 0) {
      if (typeof t != "function")
        throw new Fn("fn", ["Function", "AsyncFunction"], t);
      return !(await bp.call(this, async (...r) => !(await t(...r)), e));
    }
    ...
    async function hS(t, e, r) {
      var n;
      if (typeof t != "function")
        throw new Fn("reducer", ["Function", "AsyncFunction"], t);
      (r != null && kr(r, "options"),
        r?.signal != null && Rr(r.signal, "options.signal"));
      ...
      try {
        for await (let f of this) {
          ...
          if (
            ((a = !0),
            r != null && (c = r.signal) !== null && c !== void 0 && c.aborted)
          )
            throw new Et();
    ...
    async function dS(t) {
      ...
      for await (let n of this) {
        ...
        if (t != null && (r = t.signal) !== null && r !== void 0 && r.aborted)
          throw new Et(void 0, { cause: t.signal.reason });
        rS(e, n);
      }
      return e;
    }
  ...
  var Sa = j((Xk, _p) => {
    ...
    x();
    I();
    var { ArrayPrototypePop: bS, Promise: wS } = Ee(),
      { isIterable: mS, isNodeStream: _S, isWebStream: vS } = mt(),
      { pipelineImpl: SS } = so(),
      { finished: ES } = Ut();
    Ea();
    function AS(...t) {
    ...
    _p.exports = { finished: ES, pipeline: AS };
  });
  var Ea = j((oC, Op) => {
    "use strict";
    A();
    x();
    I();
    var { Buffer: IS } = (ke(), me(qe)),
      { ObjectDefineProperty: Ft, ObjectKeys: Ep, ReflectApply: Ap } = Ee(),
      {
        promisify: { custom: Ip },
      } = $e(),
      { streamReturningOperators: vp, promiseReturningOperators: Sp } = mp(),
      {
        codes: { ERR_ILLEGAL_CONSTRUCTOR: xp },
      } = De(),
      xS = wa(),
      { setDefaultHighWaterMark: TS, getDefaultHighWaterMark: PS } = Cn(),
      { pipeline: Tp } = so(),
      { destroyer: OS } = Ar(),
      Pp = Ut(),
      Aa = Sa(),
      Wn = mt(),
      Se = (Op.exports = $i().Stream);
    ...
    for (let t of Ep(vp)) {
      let r = function (...n) {
          if (new.target) throw xp();
          return Se.Readable.from(Ap(e, this, n));
        },
        e = vp[t];
      (Ft(r, "name", { __proto__: null, value: e.name }),
        Ft(r, "length", { __proto__: null, value: e.length }),
  ...
  var Bp = j((xC, Cp) => {
    ...
    x();
    I();
    var { Buffer: ft } = (ke(), me(qe)),
      kp = Symbol.for("BufferList");
    function we(t) {
      if (!(this instanceof we)) return new we(t);
      we._init.call(this, t);
    }
    we._init = function (e) {
      (Object.defineProperty(this, kp, { value: !0 }),
        (this._bufs = []),
        (this.length = 0),
        e && this.append(e));
    };
      ...
      if (n === 0 && i === this.length) {
        if (!s)
          return this._bufs.length === 1
            ? this._bufs[0]
            : ft.concat(this._bufs, this.length);
        for (let d = 0; d < this._bufs.length; d++)
          (this._bufs[d].copy(e, f), (f += this._bufs[d].length));
        return e;
      }
      if (c <= this._bufs[o[0]].length - h)
        return s
          ? this._bufs[o[0]].copy(e, r, h, h + c)
          : this._bufs[o[0]].slice(h, h + c);
    ...
    we.prototype.shallowSlice = function (e, r) {
      ...
      return (
        i[1] === 0
          ? s.pop()
          : (s[s.length - 1] = s[s.length - 1].slice(0, i[1])),
    ...
    we.prototype._attach = function (e, r, n) {
      ...
      if (e.buffer) r.call(this, ft.from(e.buffer, e.byteOffset, e.byteLength));
        ...
        for (let o = i; o >= 0 && o < e.length; o += s)
          this._attach(e[o], r, n);
      } else if (this._isBufferList(e)) {
        let [i, s] = n ? [e._bufs.length - 1, -1] : [0, 1];
        for (let o = i; o >= 0 && o < e._bufs.length; o += s)
          this._attach(e._bufs[o], r, n);
      } else
        (typeof e == "number" && (e = e.toString()), r.call(this, ft.from(e)));
      return this;
    };
          ...
          : typeof t == "string"
            ...
            : this._isBufferList(t)
              ...
              : Array.isArray(t.buffer)
                ? (t = ft.from(t.buffer, t.byteOffset, t.byteLength))
                : ft.isBuffer(t) || (t = ft.from(t)),
        (e = Number(e || 0)),
        isNaN(e) && (e = 0),
        e < 0 && (e = this.length + e),
        e < 0 && (e = 0),
  ...
  var Hp = j((_B, $p) => {
    ...
    I();
    var GS = Mp(),
      { EventEmitter: zS } = (er(), me(Zt)),
      Wp = qp(),
      pe = Pa(),
      ae = At()("mqtt-packet:parser"),
      Oa = class t extends zS {
        constructor() {
        ...
        _resetState() {
          (ae("_resetState: resetting packet, error, _list, and _stateCounter"),
            (this.packet = new Wp()),
            (this.error = null),
            (this._list = GS()),
        ...
        parse(e) {
          for (
            this.error && this._resetState(),
              this._list.append(e),
              ae("parse: current state: %s", this._states[this._stateCounter]);
        ...
        _parseHeader() {
          ...
          let n = e & 15,
            i = pe.requiredHeaderFlags[r];
          return i != null && n !== i
            ? this._emitError(new Error(pe.requiredHeaderFlagsErrors[r]))
            : ((this.packet.retain = (e & pe.RETAIN_MASK) !== 0),
              (this.packet.qos = (e >> pe.QOS_SHIFT) & pe.QOS_MASK),
              this.packet.qos > 2
                ? this._emitError(
                    new Error("Packet must not have both QoS bits set to 1"),
                  )
                : ((this.packet.dup = (e & pe.DUP_MASK) !== 0),
                  ae("_parseHeader: packet: %o", this.packet),
        ...
        _parseConnect() {
          ...
          if (((o.protocolId = a), this._pos >= this._list.length))
          ...
          ((s.username = this._list.readUInt8(this._pos) & pe.USERNAME_MASK),
            (s.password = this._list.readUInt8(this._pos) & pe.PASSWORD_MASK),
            (s.will = this._list.readUInt8(this._pos) & pe.WILL_FLAG_MASK));
          let c = !!(this._list.readUInt8(this._pos) & pe.WILL_RETAIN_MASK),
            f =
              (this._list.readUInt8(this._pos) & pe.WILL_QOS_MASK) >>
              pe.WILL_QOS_SHIFT;
          ...
          if (
            ((o.clean =
              (this._list.readUInt8(this._pos) & pe.CLEAN_SESSION_MASK) !== 0),
            this._pos++,
          ...
          if (
            ((o.clientId = h),
            ae("_parseConnect: packet.clientId: %s", o.clientId),
            s.will)
          ) {
            if (o.protocolVersion === 5) {
              let d = this._parseProperties();
            ...
            if (
              ((o.will.topic = e),
              ae("_parseConnect: packet.will.topic: %s", o.will.topic),
              (r = this._parseBuffer()),
              r === null)
            )
              return this._emitError(new Error("Cannot parse will payload"));
            ((o.will.payload = r),
              ae("_parseConnect: packet.will.paylaod: %s", o.will.payload));
          }
          if (s.username) {
            if (((i = this._parseString()), i === null))
              return this._emitError(new Error("Cannot parse username"));
            ((o.username = i),
              ae("_parseConnect: packet.username: %s", o.username));
          }
          if (s.password) {
        ...
        _parseConnack() {
          ...
          if (
            ((e.sessionPresent = !!(r & pe.SESSIONPRESENT_MASK)),
        ...
        _parsePublish() {
          ...
          if (!(e.qos > 0 && !this._parseMessageId())) {
            ...
            ((e.payload = this._list.slice(this._pos, e.length)),
              ae("_parsePublish: payload from buffer list: %o", e.payload));
          }
        }
        _parseSubscribe() {
          ae("_parseSubscribe");
          ...
          if (((e.subscriptions = []), !!this._parseMessageId())) {
            ...
            for (; this._pos < e.length;) {
              ...
              if (
                ((n = this._parseByte()), this.settings.protocolVersion === 5)
              ) {
                if (n & 192)
                  return this._emitError(
                    new Error(
              ...
              if (((i = n & pe.SUBSCRIBE_OPTIONS_QOS_MASK), i > 2))
                return this._emitError(
                  new Error("Invalid subscribe QoS, must be <= 2"),
                );
              if (
                ((a =
                  ((n >> pe.SUBSCRIBE_OPTIONS_NL_SHIFT) &
                    pe.SUBSCRIBE_OPTIONS_NL_MASK) !==
                  0),
                (o =
                  ((n >> pe.SUBSCRIBE_OPTIONS_RAP_SHIFT) &
                    pe.SUBSCRIBE_OPTIONS_RAP_MASK) !==
                  0),
                (s =
                  (n >> pe.SUBSCRIBE_OPTIONS_RH_SHIFT) &
                  pe.SUBSCRIBE_OPTIONS_RH_MASK),
                s > 2)
              )
                return this._emitError(
              ...
              ((c = { topic: r, qos: i }),
                this.settings.protocolVersion === 5
                  ? ((c.nl = a), (c.rap = o), (c.rh = s))
                  : this.settings.bridgeMode &&
                    ((c.rh = 0), (c.rap = !0), (c.nl = !0)),
                ae(
        ...
        _parseUnsubscribe() {
          ...
          if (((e.unsubscriptions = []), !!this._parseMessageId())) {
            ...
            for (; this._pos < e.length;) {
              ...
              if (r === null)
                return this._emitError(new Error("Cannot parse topic"));
              (ae("_parseUnsubscribe: push topic `%s` to unsubscriptions", r),
          ...
          if ((this._parseMessageId(), this.settings.protocolVersion === 5)) {
            if (e.length > 2) {
              switch (((e.reasonCode = this._parseByte()), this.packet.cmd)) {
                case "puback":
                case "pubrec":
                  if (!pe.MQTT5_PUBACK_PUBREC_CODES[e.reasonCode])
                    return this._emitError(
                ...
                case "pubrel":
                case "pubcomp":
                  if (!pe.MQTT5_PUBREL_PUBCOMP_CODES[e.reasonCode])
                    return this._emitError(
                      new Error("Invalid " + this.packet.cmd + " reason code"),
                    );
                  break;
          ...
          if ((ae("_parseDisconnect"), this.settings.protocolVersion === 5)) {
            this._list.length > 0
              ? ((e.reasonCode = this._parseByte()),
                pe.MQTT5_DISCONNECT_CODES[e.reasonCode] ||
        ...
        _parseAuth() {
          ...
          if (
            ((e.reasonCode = this._parseByte()),
            !pe.MQTT5_AUTH_CODES[e.reasonCode])
          )
            return this._emitError(new Error("Invalid auth reason code"));
          let r = this._parseProperties();
          return (
            Object.getOwnPropertyNames(r).length && (e.properties = r),
            ae("_parseAuth: result: true"),
            !0
          );
        }
        _parseMessageId() {
          ...
          return (
            ...
            e.messageId === null
              ...
              : (ae("_parseMessageId: packet.messageId %d", e.messageId), !0)
          );
        }
        _parseString(e) {
          let r = this._parseNum(),
            n = r + this._pos;
          if (r === -1 || n > this._list.length || n > this.packet.length)
            return null;
        ...
        _parseVarByteNum(e) {
          ...
          let r = 4,
            ...
            o = !1,
            a,
            c = this._pos ? this._pos : 0;
          for (; n < r && c + n < this._list.length;) {
            if (
              ((a = this._list.readUInt8(c + n++)),
              (s += i * (a & pe.VARBYTEINT_MASK)),
              (i *= 128),
              (a & pe.VARBYTEINT_FIN_MASK) === 0)
            ) {
              o = !0;
              break;
            }
          ...
          return (
            ...
            c && (this._pos += n),
            o ? (e ? (o = { bytes: n, value: s }) : (o = s)) : (o = !1),
            ae("_parseVarByteNum: result: %o", o),
            o
          );
        }
        _parseByte() {
        ...
        _parseProperties() {
          ...
          for (; this._pos < n;) {
            ...
            if (o === "userProperties") {
              ...
              if (i[o][a.name])
                if (Array.isArray(i[o][a.name])) i[o][a.name].push(a.value);
                else {
                  let c = i[o][a.name];
            ...
            i[o]
              ? Array.isArray(i[o])
                ? i[o].push(this._parseByType(pe.propertiesTypes[o]))
                : ((i[o] = [i[o]]),
                  i[o].push(this._parseByType(pe.propertiesTypes[o])))
              : (i[o] = this._parseByType(pe.propertiesTypes[o]));
          }
          return i;
        }
        _newPacket() {
  ...
  var Kp = j((TB, zp) => {
    ...
    x();
    I();
    var { Buffer: Hn } = (ke(), me(qe)),
      KS = 65536,
      Vp = {},
      QS = Hn.isBuffer(Hn.from([1, 2]).subarray(0, 1));
    function Gp(t) {
      let e = Hn.allocUnsafe(2);
      return (e.writeUInt8(t >> 8, 0), e.writeUInt8(t & 255, 1), e);
    }
    function YS() {
      for (let t = 0; t < KS; t++) Vp[t] = Gp(t);
    }
    function JS(t) {
      let r = 0,
        n = 0,
  ...
  var Qp = j((MB, Ra) => {
    ...
    typeof N > "u" ||
    !N.version ||
    N.version.indexOf("v0.") === 0 ||
    (N.version.indexOf("v1.") === 0 && N.version.indexOf("v1.8.") !== 0)
      ? (Ra.exports = { nextTick: ZS })
      : (Ra.exports = N);
    function ZS(t, e, r, n) {
      if (typeof t != "function")
      ...
      switch (i) {
        ...
        default:
          for (s = new Array(i - 1), o = 0; o < s.length;)
            s[o++] = arguments[o];
          return N.nextTick(function () {
            t.apply(null, s);
          });
  ...
  var Ba = j((FB, ny) => {
    ...
    var ue = Pa(),
      ...
      Vn = Kp(),
      rE = Qp().nextTick,
      rt = At()("mqtt-packet:writeToStream"),
      yo = Vn.cache,
      nE = Vn.generateNumber,
      iE = Vn.generateCache,
      ka = Vn.genBufVariableByteInt,
      oE = Vn.generate4ByteBuffer,
      He = Ca,
      go = !0;
    function ty(t, e, r) {
      switch (
        (rt("generate called"),
        e.cork && (e.cork(), rE(sE, e)),
        go && ((go = !1), iE()),
        rt("generate: packet.cmd: %s", t.cmd),
        t.cmd)
      ) {
        case "connect":
          return aE(t, e, r);
    ...
    Object.defineProperty(ty, "cacheNumbers", {
      get() {
        return He === Ca;
      },
      set(t) {
        t
          ? ((!yo || Object.keys(yo).length === 0) && (go = !0), (He = Ca))
          : ((go = !1), (He = wE));
      },
    });
    function sE(t) {
    ...
    function aE(t, e, r) {
      ...
      a === void 0 && (a = !0);
      let g = 0;
      if (!i || (typeof i != "string" && !se.isBuffer(i)))
        return (e.destroy(new Error("Invalid protocolId")), !1);
      if (((g += i.length + 2), s !== 3 && s !== 4 && s !== 5))
        return (e.destroy(new Error("Invalid protocol version")), !1);
      if (
        ((g += 1),
        (typeof f == "string" || se.isBuffer(f)) && (f || s >= 4) && (f || a))
      )
        g += se.byteLength(f) + 2;
      else {
        if (s < 4)
          return (
            e.destroy(new Error("clientId must be supplied before 3.1.1")),
            !1
          );
        if (a * 1 === 0)
          return (
      ...
      if (typeof c != "number" || c < 0 || c > 65535 || c % 1 !== 0)
      ...
      if (o) {
        ...
        if (((g += se.byteLength(o.topic) + 2), (g += 2), o.payload))
          if (o.payload.length >= 0)
            typeof o.payload == "string"
              ? (g += se.byteLength(o.payload))
              : (g += o.payload.length);
      ...
      let b = !1;
      if (h != null)
        if (ey(h)) ((b = !0), (g += se.byteLength(h) + 2));
        else return (e.destroy(new Error("Invalid username")), !1);
      if (d != null) {
        if (!b)
          return (
            e.destroy(new Error("Username is required to use password")),
            !1
          );
        if (ey(d)) g += ry(d) + 2;
        else return (e.destroy(new Error("Invalid password")), !1);
      }
      (e.write(ue.CONNECT_HEADER),
        nt(e, g),
        pn(e, i),
        n.bridgeMode && (s += 128),
        e.write(
      ...
      let w = 0;
      return (
        (w |= h != null ? ue.USERNAME_MASK : 0),
        (w |= d != null ? ue.PASSWORD_MASK : 0),
        (w |= o && o.retain ? ue.WILL_RETAIN_MASK : 0),
        (w |= o && o.qos ? o.qos << ue.WILL_QOS_SHIFT : 0),
        (w |= o ? ue.WILL_FLAG_MASK : 0),
        (w |= a ? ue.CLEAN_SESSION_MASK : 0),
        e.write(se.from([w])),
        He(e, c),
        s === 5 && P.write(),
        pn(e, f),
        o && (s === 5 && S.write(), Br(e, o.topic), pn(e, o.payload)),
        h != null && pn(e, h),
        d != null && pn(e, d),
        !0
      );
    ...
    function uE(t, e, r) {
      ...
      return (
        e.write(ue.CONNACK_HEADER),
        nt(e, a),
        e.write(i.sessionPresent ? ue.SESSIONPRESENT_HEADER : tE),
        e.write(se.from([s])),
        c?.write(),
        !0
      );
    ...
    function lE(t, e, r) {
      ...
      if (
        (se.isBuffer(c) ? (d += c.length) : (d += se.byteLength(c)),
        s && typeof f != "number")
      )
      ...
      return (
        e.write(ue.PUBLISH_HEADER[s][i.dup ? 1 : 0][o ? 1 : 0]),
        nt(e, d),
        He(e, ry(a)),
        e.write(a),
        s > 0 && He(e, f),
        m?.write(),
        rt("publish: payload: %o", c),
        e.write(c)
      );
    }
    function cE(t, e, r) {
      let n = r ? r.protocolVersion : 4,
        ...
        s = i.cmd || "puback",
        o = i.messageId,
        a = i.dup && s === "pubrel" ? ue.DUP_MASK : 0,
        c = 0,
        f = i.reasonCode,
        h = i.properties,
        d = n === 5 ? 3 : 2;
      if ((s === "pubrel" && (c = 1), typeof o != "number"))
        return (e.destroy(new Error("Invalid messageId")), !1);
      let m = null;
      ...
      return (
        e.write(ue.ACKS[s][c][a][0]),
        d === 3 && (d += f !== 0 ? 1 : -1),
        nt(e, d),
        He(e, o),
        n === 5 && d !== 2 && e.write(se.from([f])),
        m !== null ? m.write() : d === 4 && e.write(se.from([0])),
        !0
      );
    }
    function fE(t, e, r) {
      ...
      if (typeof a == "object" && a.length)
        for (let m = 0; m < a.length; m += 1) {
          ...
          if (typeof g != "string")
            return (
              e.destroy(new Error("Invalid subscriptions - invalid topic")),
              !1
            );
          if (typeof P != "number")
            return (
              e.destroy(new Error("Invalid subscriptions - invalid qos")),
              !1
            );
          if (n === 5) {
            if (typeof (a[m].nl || !1) != "boolean")
              return (
                e.destroy(
      ...
      (rt("subscribe: writing to stream: %o", ue.SUBSCRIBE_HEADER),
        e.write(ue.SUBSCRIBE_HEADER[1][s ? 1 : 0][0]),
        nt(e, f),
        He(e, o),
        h !== null && h.write());
      let d = !0;
      for (let m of a) {
        let g = m.topic,
          ...
          _;
        (Br(e, g),
          (_ = ue.SUBSCRIBE_OPTIONS_QOS[P]),
          n === 5 &&
            ((_ |= S ? ue.SUBSCRIBE_OPTIONS_NL : 0),
            (_ |= b ? ue.SUBSCRIBE_OPTIONS_RAP : 0),
            (_ |= w ? ue.SUBSCRIBE_OPTIONS_RH[w] : 0)),
          (d = e.write(se.from([_]))));
      }
      return d;
    }
    function hE(t, e, r) {
      ...
      if (typeof s != "number")
        return (e.destroy(new Error("Invalid messageId")), !1);
      if (((c += 2), typeof o == "object" && o.length))
    ...
    function dE(t, e, r) {
      ...
      (e.write(ue.UNSUBSCRIBE_HEADER[1][o ? 1 : 0][0]),
        nt(e, f),
        He(e, s),
        h !== null && h.write());
      let d = !0;
    ...
    function pE(t, e, r) {
      ...
      return (
        e.write(ue.ACKS[f][h][o][0]),
        nt(e, d),
        He(e, s),
        m !== null && m.write(),
        n === 5 && e.write(se.from(a)),
        !0
      );
    }
    function yE(t, e, r) {
    ...
    function gE(t, e, r) {
      ...
      return (
        e.write(se.from([ue.codes.disconnect << 4])),
        nt(e, a),
        n === 5 && e.write(se.from([s])),
        c !== null && c.write(),
        !0
      );
    }
    function bE(t, e, r) {
      ...
      return c
        ? ((a += c.length),
          e.write(se.from([ue.codes.auth << 4])),
          nt(e, a),
          e.write(se.from([s])),
          c !== null && c.write(),
          !0)
    ...
    var Yp = {};
    function nt(t, e) {
      if (e > ue.VARBYTEINT_MAX)
        return (
          t.destroy(new Error(`Invalid variable byte integer: ${e}`)),
          !1
        );
      let r = Yp[e];
      return (
        r || ((r = ka(e)), e < 16384 && (Yp[e] = r)),
        rt("writeVarByteInt: writing to stream: %o", r),
        t.write(r)
      );
    }
    function Br(t, e) {
    ...
    function Ca(t, e) {
      return (
        rt("writeNumberCached: number: %d", e),
        rt("writeNumberCached: %o", yo[e]),
        t.write(yo[e])
      );
    }
    function wE(t, e) {
    ...
    function ar(t, e) {
      ...
      let r = 0;
      function n(s, o) {
        let a = ue.propertiesTypes[s],
          c = 0;
        switch (a) {
          case "byte": {
            if (typeof o != "boolean")
              return (t.destroy(new Error(`Invalid ${s}: ${o}`)), !1);
            c += 2;
            break;
          }
          case "int8": {
                ...
                Array.isArray(d)
                  ? (f += d.reduce(
                      (m, g) => (
                        (m +=
                          3 +
                          se.byteLength(h.toString()) +
                          2 +
                          se.byteLength(g.toString())),
                        m
                      ),
                      0,
                    ))
          ...
          default:
            return (t.destroy(new Error(`Invalid property ${s}: ${o}`)), !1);
        }
        return c;
      }
      if (e)
      ...
      switch (ue.propertiesTypes[e]) {
        ...
        case "pair": {
          Object.getOwnPropertyNames(r).forEach((i) => {
            ...
            Array.isArray(s)
              ? s.forEach((o) => {
                  (t.write(se.from([ue.properties[e]])),
                    Jp(t, i.toString(), o.toString()));
                })
              : (t.write(se.from([ue.properties[e]])),
                Jp(t, i.toString(), s.toString()));
          });
          break;
        }
        default:
          return (
            t.destroy(new Error(`Invalid property ${e} value: ${r}`)),
            !1
          );
      }
    }
    function Zp(t, e, r) {
      ...
      for (let n in e)
        if (Object.prototype.hasOwnProperty.call(e, n) && e[n] != null) {
          let i = e[n];
          if (Array.isArray(i))
            for (let s = 0; s < i.length; s++) Xp(t, n, i[s]);
          else Xp(t, n, i);
        }
    }
    function ry(t) {
    ...
    var Ma = class extends vE {
      ...
      concat() {
        let e = 0,
          ...
          i = 0,
          s;
        for (s = 0; s < n.length && n[s] !== void 0; s++)
          (typeof n[s] != "string"
            ? (r[s] = n[s].length)
            : (r[s] = iy.byteLength(n[s])),
            (e += r[s]));
        let o = iy.allocUnsafe(e);
        for (s = 0; s < n.length && n[s] !== void 0; s++)
          typeof n[s] != "string"
            ? (n[s].copy(o, i), (i += r[s]))
            : (o.write(n[s], i), (i += r[s]));
  ...
  var ly = j((uM, uy) => {
    ...
    function EE(t) {
      ...
      if (
        ...
        e.set(Map, (o, a) => new Map(n(Array.from(o), a))),
        e.set(Set, (o, a) => new Set(n(Array.from(o), a))),
      ...
      function n(o, a) {
        ...
        for (let h = 0; h < c.length; h++) {
          ...
          typeof m != "object" || m === null
            ? (f[d] = m)
            : m.constructor !== Object && (r = e.get(m.constructor))
              ? (f[d] = r(m, a))
      ...
      function i(o) {
        ...
        if (o.constructor !== Object && (r = e.get(o.constructor)))
          return r(o, i);
        let a = {};
        for (let c in o) {
    ...
    function AE(t) {
      ...
      if (
        ...
        n.set(Map, (c, f) => new Map(s(Array.from(c), f))),
        n.set(Set, (c, f) => new Set(s(Array.from(c), f))),
        t.constructorHandlers)
      )
        for (let c of t.constructorHandlers) n.set(c[0], c[1]);
      let i = null;
      return t.proto ? a : o;
      function s(c, f) {
        let h = Object.keys(c),
        ...
        for (let m = 0; m < h.length; m++) {
          ...
          else if (P.constructor !== Object && (i = n.get(P.constructor)))
            d[g] = i(P, f);
  ...
  var Na = j((wo) => {
    ...
    function IE(t) {
      ...
      for (let e = 0; e < t.length; e++) if (!hy(t[e])) return t[e];
      return null;
    }
  });
  var Ua = j((La) => {
    ...
    var xE = or(),
      ...
      qa = class {
        ...
        createStream() {
          let e = new xE.Readable(TE),
            r = [],
            n = !1,
            i = 0;
          return (
            this._inflights.forEach((s, o) => {
              r.push(s);
            }),
            (e._read = () => {
        ...
        del(e, r) {
          ...
          return (
            n
              ? (this._inflights.delete(e.messageId), r(null, n))
  ...
  var py = j((Da) => {
    ...
    var dy = [0, 16, 128, 131, 135, 144, 145, 151, 153],
      OE = (t, e, r) => {
        (t.log("handlePublish: packet %o", e),
          (r = typeof r < "u" ? r : t.noop));
        ...
        if (t.options.protocolVersion === 5) {
          let c;
          if ((e.properties && (c = e.properties.topicAlias), typeof c < "u"))
            if (n.length === 0)
              if (c > 0 && c <= 65535) {
            ...
            else if (t.topicAliasRecv.put(n, c))
              t.log("handlePublish :: registered topic: %s - alias: %d", n, c);
            else {
              (t.log("handlePublish :: topic alias out of range. alias: %d", c),
                t.emit(
                  "error",
                  new Error("Received Topic Alias is out of range"),
                ));
        ...
        switch ((t.log("handlePublish: qos %d", s), s)) {
          case 2: {
            a.customHandleAcks(n, i, e, (c, f) => {
              if ((typeof c == "number" && ((f = c), (c = null)), c))
                return t.emit("error", c);
              if (dy.indexOf(f) === -1)
                return t.emit(
                  "error",
              ...
              f
                ? t._sendPacket(
                    { cmd: "pubrec", messageId: o, reasonCode: f },
                    r,
                  )
          ...
          case 1: {
            a.customHandleAcks(n, i, e, (c, f) => {
              ...
              (f || t.emit("message", n, i, e),
                t.handleMessage(e, (h) => {
                  if (h) return r && r(h);
                  t._sendPacket(
                    { cmd: "puback", messageId: o, reasonCode: f },
                    r,
                  );
                }));
            });
  ...
  var Mr = j((ht) => {
    ...
    ht.MQTTJS_VERSION =
      ht.nextTick =
      ht.ErrorWithSubackPacket =
      ht.ErrorWithReasonCode =
        void 0;
    ht.applyMixin = kE;
    ...
    function kE(t, e, r = !1) {
      ...
      for (;;) {
        let i = n[0],
          s = Object.getPrototypeOf(i);
        if (s?.prototype) n.unshift(s);
        else break;
      }
      for (let i of n)
        for (let s of Object.getOwnPropertyNames(i.prototype))
          (r || s !== "constructor") &&
            Object.defineProperty(
              t.prototype,
              s,
              Object.getOwnPropertyDescriptor(i.prototype, s) ??
                Object.create(null),
            );
    }
    ht.nextTick =
      typeof N?.nextTick == "function"
        ? N.nextTick
        : (t) => {
            setTimeout(t, 0);
          };
    ht.MQTTJS_VERSION = yy().version;
  });
  var zn = j((ur) => {
    "use strict";
    A();
    ...
    var CE = (t, e) => {
      ...
      switch ((t.log("_handleAck :: packet type", n), n)) {
        ...
        case "puback": {
          let a = e.reasonCode;
          a && a > 0 && a !== 16
            ? ((o = new gy.ErrorWithReasonCode(
                `Publish error: ${ur.ReasonCodes[a]}`,
                a,
              )),
        ...
        case "suback": {
          ...
          for (let c = 0; c < a.length; c++) {
            let f = a[c];
            if ((f & 128) !== 0) {
              ((o = new Error(`Subscribe error: ${ur.ReasonCodes[f]}`)),
                (o.code = f));
  ...
  var wy = j((Wa) => {
    ...
    var by = Mr(),
      ...
      ME = (t, e) => {
        ...
        if (n !== 5) {
          let s = new by.ErrorWithReasonCode(
            `Protocol error: Auth packets are only supported in MQTT 5. Your version:${n}`,
            i,
          );
          t.emit("error", s);
          return;
        ...
        t.handleAuth(e, (s, o) => {
          ...
          if (i === 24) ((t.reconnecting = !1), t._sendPacket(o));
            ...
            let a = new by.ErrorWithReasonCode(
              `Connection refused: ${BE.ReasonCodes[i]}`,
              i,
            );
            t.emit("error", a);
          }
  ...
  var Ey = j((_o) => {
    ...
    var gn =
        ...
        typeof performance.now == "function"
          ...
          : Date,
      _y = new Set(),
      $a = typeof N == "object" && N ? N : {},
      vy = (t, e, r, n) => {
        typeof $a.emitWarning == "function"
          ? $a.emitWarning(t, e, r, n)
          : console.error(`[${r}] ${e}: ${t}`);
      },
      mo = globalThis.AbortController,
    ...
    var NE = (t) => !_y.has(t),
      d2 = Symbol("type"),
      lr = (t) => t && t === Math.floor(t) && t > 0 && isFinite(t),
      Sy = (t) =>
        lr(t)
          ? t <= Math.pow(2, 8)
            ? Uint8Array
      ...
      Va = class t {
        ...
        constructor(e) {
          ...
          if (((this.#k = w), b !== void 0 && typeof b != "function"))
          ...
          if (
            ...
            (this.#i = 0),
            (this.#b = 0),
            typeof f == "function" && (this.#y = f),
            typeof h == "function"
              ? ((this.#g = h), (this.#s = []))
              : ((this.#g = void 0), (this.#s = void 0)),
            (this.#v = !!this.#y),
            (this.#c = !!this.#g),
            ...
            if (this.#f !== 0 && !lr(this.#f))
              throw new TypeError(
                "maxSize must be a positive integer if specified",
              );
            if (!lr(this.maxEntrySize))
              throw new TypeError(
          ...
          if (
            ...
            (this.ttlResolution = lr(i) || i === 0 ? i : 1),
            (this.ttlAutopurge = !!s),
            (this.ttl = n || 0),
            this.ttl)
          ) {
          ...
          if (this.#u === 0 && this.ttl === 0 && this.#f === 0)
            throw new TypeError(
        ...
        #F() {
          ...
          ((this.#b = 0),
            ...
            (this.#C = (r, n, i) => {
              ...
              ((this.#b += e[r]),
                i && ((i.entrySize = n), (i.totalCalculatedSize = this.#b)));
            }));
        }
        #P = (e) => {};
        #C = (e, r, n) => {};
        ...
        *#S({ allowStale: e = this.allowStale } = {}) {
          if (this.#i)
            for (
              let r = this.#o;
              !(
                !this.#U(r) || ((e || !this.#p(r)) && (yield r), r === this.#a)
              );
            )
              r = this.#h[r];
        }
        *#E({ allowStale: e = this.allowStale } = {}) {
          if (this.#i)
            for (
              let r = this.#a;
              !(
                !this.#U(r) || ((e || !this.#p(r)) && (yield r), r === this.#o)
              );
            )
              r = this.#l[r];
        }
        ...
        *rvalues() {
        ...
        find(e, r = {}) {
          for (let n of this.#S()) {
            let i = this.#e[n],
              s = this.#t(i) ? i.__staleWhileFetching : i;
            if (s !== void 0 && e(s, this.#r[n], this))
              return this.get(this.#r[n], r);
          }
        }
        forEach(e, r = this) {
          for (let n of this.#S()) {
        ...
        info(e) {
          ...
          if (r === void 0) return;
          let n = this.#e[r],
            i = this.#t(n) ? n.__staleWhileFetching : n;
          if (i === void 0) return;
          let s = { value: i };
          if (this.#d && this.#_) {
            let o = this.#d[r],
        ...
        set(e, r, n = {}) {
          ...
          let {
            ...
            { noUpdateTTL: f = this.noUpdateTTL } = n,
            h = this.#L(e, r, n.size || 0, a);
          ...
          if (d === void 0)
            ...
            if (r !== m) {
              if (this.#x && this.#t(m)) {
                ...
                g !== void 0 &&
                  !o &&
                  (this.#v && this.#y?.(g, e, "set"),
                  this.#c && this.#s?.push([g, e, "set"]));
              } else
                o ||
                  (this.#v && this.#y?.(m, e, "set"),
                  this.#c && this.#s?.push([m, e, "set"]));
          ...
          if (
            (i !== 0 && !this.#d && this.#N(),
            this.#d && (f || this.#q(d, i, s), c && this.#I(c, d)),
            !o && this.#c && this.#s)
          ) {
            let m = this.#s,
              g;
        ...
        #B(e) {
          ...
          return (
            this.#x && this.#t(i)
              ...
              : (this.#v || this.#c) &&
                (this.#v && this.#y?.(i, n, "evict"),
                this.#c && this.#s?.push([i, n, "evict"])),
            this.#P(r),
            e &&
              ((this.#r[r] = void 0), (this.#e[r] = void 0), this.#w.push(r)),
            this.#i === 1
              ? ((this.#a = this.#o = 0), (this.#w.length = 0))
              : (this.#a = this.#l[r]),
            this.#n.delete(n),
            this.#i--,
            r
        ...
        #M(e, r, n, i) {
          ...
          let c = { signal: o.signal, options: n, context: i },
            f = (S, b = !1) => {
              let { aborted: w } = o.signal,
                _ = n.ignoreFetchAbort && S !== void 0;
              if (
                (n.status &&
                  (w && !b
                ...
                this.#e[r] === g &&
                  (S === void 0
                    ...
                    : (n.status && (n.status.fetchUpdated = !0),
                      this.set(e, S, c.options))),
                S
              );
            },
            h = (S) => (
              n.status &&
                ((n.status.fetchRejected = !0), (n.status.fetchError = S)),
              d(S)
            ),
            d = (S) => {
              let { aborted: b } = o.signal,
                w = b && n.allowStaleOnFetchAbort,
                _ = w || n.allowStaleOnFetchRejection,
                R = _ || n.noDeleteOnFetchRejection,
                T = g;
              if (
                (this.#e[r] === g &&
                  (!R || T.__staleWhileFetching === void 0
                    ? this.#A(e, "fetch")
                    : w || (this.#e[r] = T.__staleWhileFetching)),
                _)
              )
                return (
                  n.status &&
            ...
            m = (S, b) => {
              ...
              (w &&
                ...
                w.then((_) => S(_ === void 0 ? void 0 : _), b),
                o.signal.addEventListener("abort", () => {
                  (!n.ignoreFetchAbort || n.allowStaleOnFetchAbort) &&
                    (S(void 0),
                    n.allowStaleOnFetchAbort && (S = (_) => f(_, !0)));
                }));
            };
          n.status && (n.status.fetchDispatched = !0);
          let g = new Promise(m).then(f, h),
            P = Object.assign(g, {
              __abortController: o,
          ...
          return (
            r === void 0
              ? (this.set(e, P, { ...c.options, status: void 0 }),
                (r = this.#n.get(e)))
              : (this.#e[r] = P),
            P
          );
        ...
        #t(e) {
          ...
          return (
            ...
            r.__abortController instanceof mo
          );
        }
        async fetch(e, r = {}) {
          let {
          ...
          if (T === void 0) {
            ...
            if (this.#t(y)) {
              ...
              return (
                w && ((w.fetch = "inflight"), U && (w.returnedStale = !0)),
                U ? y.__staleWhileFetching : (y.__returned = y)
              );
            }
            let O = this.#p(T);
            if (!b && !O)
            ...
            let v = this.#M(e, T, R, S),
              F = v.__staleWhileFetching !== void 0 && n;
            return (
              w &&
                ((w.fetch = O ? "stale" : "refresh"),
                F && O && (w.returnedStale = !0)),
              F ? v.__staleWhileFetching : (v.__returned = v)
            );
          }
        }
                ...
                ? (o && (o.get = "stale"),
                  f
                    ...
                    : (s || this.#A(e, "expire"),
                      ...
                      n ? c : void 0))
                : (o && (o.get = "hit"),
                  f ? c.__staleWhileFetching : (this.#O(a), i && this.#T(a), c))
            );
          } else o && (o.get = "miss");
        }
        #D(e, r) {
  ...
  var eu = j((Po) => {
    ...
    var VE = It(),
      To = xt(),
      Za = class extends VE.ContainerIterator {
        constructor(e, r) {
          (super(r),
            (this.o = e),
            this.iteratorType === 0
              ? ((this.pre = function () {
                  return (
                    this.o === 0 && (0, To.throwIteratorAccessError)(),
                    (this.o -= 1),
                    this
                  );
                }),
              ...
              : ((this.pre = function () {
                ...
                (this.next = function () {
                  return (
                    this.o === -1 && (0, To.throwIteratorAccessError)(),
                    (this.o -= 1),
                    this
                  );
                })));
    ...
    var Nr = class t extends zE.RandomIterator {
      ...
      tu = class extends GE.default {
        ...
        insert(e, r, n = 1) {
          ...
          return (
            this.J.splice(e, 0, ...new Array(n).fill(r)),
            (this.i += n),
            this.i
          );
        }
        find(e) {
          for (let r = 0; r < this.i; ++r)
            if (this.J[r] === e) return new Nr(r, this);
          return this.end();
        }
        reverse() {
          this.J.reverse();
    ...
    var Lr = class t extends JE.ContainerIterator {
        constructor(e, r, n, i) {
          (super(i),
            ...
            this.iteratorType === 0
              ? ((this.pre = function () {
                  return (
                    this.o.L === this.h && (0, qr.throwIteratorAccessError)(),
                    (this.o = this.o.L),
                    this
                  );
                }),
                (this.next = function () {
                  return (
                    this.o === this.h && (0, qr.throwIteratorAccessError)(),
                    (this.o = this.o.B),
                    this
                  );
                }))
              : ((this.pre = function () {
                  return (
                    this.o.B === this.h && (0, qr.throwIteratorAccessError)(),
                    (this.o = this.o.B),
                    this
                  );
                }),
      ...
      ru = class extends YE.default {
        ...
        eraseElementByIterator(e) {
          let r = e.o;
          return (
            r === this.h && (0, qr.throwIteratorAccessError)(),
            (e = e.next()),
            this.V(r),
            e
          );
    ...
    var Ur = class t extends t1.RandomIterator {
      ...
      nu = class extends e1.default {
        constructor(e = [], r = 4096) {
          ...
          ((this.j = this.R = (this.P >> 1) - (i >> 1)),
            (this.D = this.N = (this.F - (n % this.F)) >> 1));
          let s = this;
          e.forEach(function (o) {
            s.pushBack(o);
          });
        ...
        O(e) {
          ...
          return (
            ...
            (s %= this.P),
            i < 0 && (i += this.F),
            { curNodeBucketIndex: s, curNodePointerIndex: i }
          );
        }
        clear() {
        ...
        find(e) {
          for (let r = 0; r < this.i; ++r)
            if (this.getElementByPos(r) === e) return new Ur(r, this);
          return this.end();
        }
        reverse() {
          let e = 0,
      ...
      ou = class extends i1.Container {
        constructor(
          ...
          (super(),
            ...
            (this.v = e),
            r
              ? ((this.re = ky.TreeNodeEnableIndex),
                (this.M = function (n, i, s) {
                  let o = this.ne(n, i, s);
                  if (o) {
                    let a = o.tt;
            ...
            if (r === n.U) {
              ...
              if (i && i.ee === 1) {
                ...
                return (
                  ...
                  (n.tt = e),
                  (n.ee = 1),
                  { parentNode: r, grandParent: n, curNode: e }
                );
              } else
                ((r.ee = 0),
                  n === this.Y ? (this.Y = n.se()) : n.se(),
                  (n.ee = 1));
            } else {
              let i = n.U;
              if (i && i.ee === 1) {
        ...
        updateKeyByIterator(e, r) {
          let n = e.o;
          if (
            (n === this.h && (0, Cy.throwIteratorAccessError)(), this.i === 1)
          )
            return ((n.u = r), !0);
          if (n === this.h.U)
            return this.v(n.B().u, r) > 0 ? ((n.u = r), !0) : !1;
          if (n === this.h.W)
            return this.v(n.L().u, r) < 0 ? ((n.u = r), !0) : !1;
          let i = n.L().u;
        ...
        eraseElementByIterator(e) {
          let r = e.o;
          r === this.h && (0, Cy.throwIteratorAccessError)();
          let n = r.W === void 0;
          return (
            e.iteratorType === 0
              ? n && e.next()
  ...
  var uu = j((No) => {
    ...
    var s1 = It(),
      Mo = xt(),
      au = class extends s1.ContainerIterator {
        constructor(e, r, n) {
          (super(n),
            (this.o = e),
            (this.h = r),
            this.iteratorType === 0
              ? ((this.pre = function () {
                  return (
                    this.o === this.h.U && (0, Mo.throwIteratorAccessError)(),
                    (this.o = this.o.L()),
                    this
                  );
                }),
                (this.next = function () {
                  return (
                    this.o === this.h && (0, Mo.throwIteratorAccessError)(),
                    (this.o = this.o.B()),
                    this
                  );
                }))
              : ((this.pre = function () {
                  return (
                    this.o === this.h.W && (0, Mo.throwIteratorAccessError)(),
                    (this.o = this.o.B()),
                    this
                  );
                }),
  ...
  var My = j((qo) => {
    ...
    var dt = class t extends l1.default {
        ...
        get pointer() {
          return (
            this.o === this.h && (0, c1.throwIteratorAccessError)(),
            this.o.u
          );
        }
        copy() {
  ...
  var gu = j((mn) => {
    ...
    var pu = class extends Ly.ContainerIterator {
      constructor(e, r, n) {
        (super(n),
          (this.o = e),
          (this.h = r),
          this.iteratorType === 0
            ? ((this.pre = function () {
                return (
                  this.o.L === this.h && (0, Kn.throwIteratorAccessError)(),
                  (this.o = this.o.L),
                  this
                );
              }),
              (this.next = function () {
                return (
                  this.o === this.h && (0, Kn.throwIteratorAccessError)(),
                  (this.o = this.o.B),
                  this
                );
              }))
            : ((this.pre = function () {
                return (
                  this.o.B === this.h && (0, Kn.throwIteratorAccessError)(),
                  (this.o = this.o.B),
                  this
                );
              }),
    ...
    var yu = class extends Ly.Container {
      constructor() {
        (super(),
          (this.H = []),
          (this.g = {}),
      ...
      M(e, r, n) {
        ...
        return (
          this.i === 0 ? ((this.p = i), (this.h.B = i)) : (this._.B = i),
          (this._ = i),
          (this.h.L = i),
          ++this.i
        );
      ...
      eraseElementByIterator(e) {
        let r = e.o;
        return (
          r === this.h && (0, Kn.throwIteratorAccessError)(),
          this.V(r),
          e.next()
        );
      }
  ...
  var Dy = j((Uo) => {
    ...
    var Uy = gu(),
      w1 = xt(),
      Dr = class t extends Uy.HashContainerIterator {
        constructor(e, r, n, i) {
          (super(e, r, i), (this.container = n));
        }
        get pointer() {
  ...
  var Fy = j((Do) => {
    ...
    var jr = class t extends jy.HashContainerIterator {
        constructor(e, r, n, i) {
          (super(e, r, i), (this.container = n));
        }
        get pointer() {
      ...
      wu = class extends jy.HashContainer {
        constructor(e = []) {
          super();
          let r = this;
          e.forEach(function (n) {
  ...
  var Hy = j((Zq, $y) => {
    ...
    x();
    I();
    var M1 = Wy().OrderedSet,
      Pt = At()("number-allocator:trace"),
      N1 = At()("number-allocator:error");
    function Ve(t, e) {
    ...
    function Ot(t, e) {
      ...
      ((this.min = t),
        (this.max = e),
        (this.ss = new M1([], (r, n) => r.compare(n))),
        Pt("Create"),
        this.clear());
    }
    ...
    Ot.prototype.alloc = function () {
      ...
      return (
        n + 1 <= r
          ? this.ss.updateKeyByIterator(t, new Ve(e + 1, r))
    ...
    Ot.prototype.use = function (t) {
      ...
      if (!r.equals(this.ss.end())) {
        ...
        return r.pointer.equals(e)
          ? (this.ss.eraseElementByIterator(r), Pt("use():" + t), !0)
          : n > t
            ? !1
            : n === t
              ? (this.ss.updateKeyByIterator(r, new Ve(n + 1, i)),
                Pt("use():" + t),
                !0)
              : i === t
                ? (this.ss.updateKeyByIterator(r, new Ve(n, i - 1)),
                  Pt("use():" + t),
                  !0)
                : (this.ss.updateKeyByIterator(r, new Ve(t + 1, i)),
                  this.ss.insert(new Ve(n, t - 1)),
                  Pt("use():" + t),
                  !0);
      }
    ...
    Ot.prototype.free = function (t) {
      ...
      if (r.equals(this.ss.end())) {
        ...
        r.pointer.high + 1 === t
          ? this.ss.updateKeyByIterator(r, new Ve(n, t))
          : this.ss.insert(e);
        ...
        r.pointer.high + 1 === t
          ? t + 1 === n
            ? (this.ss.eraseElementByIterator(r),
              this.ss.updateKeyByIterator(r, new Ve(s, i)))
            : this.ss.updateKeyByIterator(r, new Ve(s, t))
          : t + 1 === n
            ? (this.ss.eraseElementByIterator(r.next()),
              this.ss.insert(new Ve(t, i)))
            : this.ss.insert(e);
      }
      Pt("free():" + t);
    };
    Ot.prototype.clear = function () {
      (Pt("clear()"),
        this.ss.clear(),
        this.ss.insert(new Ve(this.min, this.max)));
    };
  ...
  var Gy = j((vu) => {
    ...
    var L1 = Ey(),
      ...
      _u = class {
        ...
        constructor(e) {
          e > 0 &&
            ((this.aliasToTopic = new L1.LRUCache({ max: e })),
            (this.topicToAlias = {}),
            (this.numberAllocator = new U1.NumberAllocator(1, e)),
            (this.max = e),
            (this.length = 0));
        }
        put(e, r) {
  ...
  var zy = j((Qn) => {
    ...
    var j1 = zn(),
      ...
      $1 = (t, e) => {
        ...
        let { options: r } = t,
          i = r.protocolVersion === 5 ? e.reasonCode : e.returnCode;
        if (
          ...
          if (e.properties.topicAliasMaximum) {
            ...
            e.properties.topicAliasMaximum > 0 &&
              (t.topicAliasSend = new F1.default(
        ...
        if (i === 0) ((t.reconnecting = !1), t._onConnect(e));
          ...
          let s = new W1.ErrorWithReasonCode(
            `Connection refused: ${j1.ReasonCodes[i]}`,
            i,
          );
          (t.emit("error", s),
  ...
  var Ky = j((Su) => {
    ...
    var H1 = (t, e, r) => {
      ...
      let n = typeof r < "u" ? r : t.noop,
        { messageId: i } = e,
        s = { cmd: "pubcomp", messageId: i };
    ...
    var V1 = Jn(py()),
      ...
      Y1 = (t, e, r) => {
        ...
        if (
          n.protocolVersion === 5 &&
          n.properties &&
          n.properties.maximumPacketSize &&
          n.properties.maximumPacketSize < e.length
        )
          return (
  ...
  var eg = j((vU, Zn) => {
    ...
    var Zy = Xn().default;
    function eA(t, e) {
      if (Zy(t) != "object" || !t) return t;
      var r = t[Symbol.toPrimitive];
      if (r !== void 0) {
        var n = r.call(t, e || "default");
        if (Zy(n) != "object") return n;
  ...
  var rg = j((NU, ti) => {
    ...
    ((ti.exports = oA),
      (ti.exports.__esModule = !0),
      (ti.exports.default = ti.exports));
  });
  var ng = j((WU, ri) => {
    A();
    x();
      ...
      if (r != null) {
        ...
        try {
          if (((s = (r = r.call(t)).next), e === 0)) {
            ...
            for (
              ;
              !(c = (n = s.call(r)).done) && (a.push(n.value), a.length !== e);
              c = !0
            );
        } catch (h) {
          ((f = !0), (i = h));
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
    ...
    ((si.exports = cA),
      (si.exports.__esModule = !0),
      (si.exports.default = si.exports));
  });
  var lg = j((ED, ai) => {
    A();
    x();
  ...
  var fg = j((RD, ui) => {
    ...
    ((ui.exports = gA),
      (ui.exports.__esModule = !0),
      (ui.exports.default = ui.exports));
  });
  var Ru = j((LD, li) => {
    A();
    x();
  ...
  var Cu = j((JD, Ht) => {
    ...
    function hg() {
      ...
      function s(g, P, S, b) {
        var w = P && P.prototype instanceof a ? P : a,
                      ...
                      if ((v || (z = "next"), (e = O[z]))) {
                        ...
                        (v === 1 && (e = O.return) && e.call(O),
                          v < 2 &&
                            ...
                            (v = 1)));
                      O = t;
                    } else if ((e = (Q = W.n < 0) ? M : R.call(T, W)) !== o)
                      break;
                  } catch (G) {
                    ((O = t), (v = 1), (M = G));
                  } finally {
      ...
      var h = [][n]
          ...
          : (Rt((e = {}), n, function () {
            ...
            e),
        d = (f.prototype = a.prototype = Object.create(h));
      function m(g) {
        return (
          Object.setPrototypeOf
            ? Object.setPrototypeOf(g, f)
            : ((g.__proto__ = f), Rt(g, i, "GeneratorFunction")),
          (g.prototype = Object.create(d)),
          g
        );
      }
      return (
  ...
  var pg = j((I3, di) => {
    ...
    function AA(t) {
      ...
      return function i() {
        for (; r.length;)
          if ((n = r.pop()) in e) return ((i.value = n), (i.done = !1), i);
        return ((i.done = !0), i);
      };
    }
    ((di.exports = AA),
  ...
  var yg = j((C3, pi) => {
    ...
    ((pi.exports = xA),
      (pi.exports.__esModule = !0),
      (pi.exports.default = pi.exports));
  });
  var bg = j((D3, Vt) => {
    A();
    x();
    ...
    function Lu() {
      ...
      function n(o) {
        ...
        return (
          !!a && (a === r || (a.displayName || a.name) === "GeneratorFunction")
        );
      }
          ...
          (a ||
            ((a = {
              ...
              delegateYield: function (d, m, g) {
                return ((a.resultName = m), c(f.d, gg(d), g));
              },
              finish: function (d) {
                return c(f.f, d);
              },
            ...
            a.resultName && ((a[a.resultName] = f.v), (a.resultName = void 0)),
            (a.sent = f.v),
            (a.next = f.n));
          try {
    ...
    (function (t, e) {
      ...
      function a(S) {
        for (var b = 1; b < arguments.length; b++) {
          ...
          b % 2
            ? o(Object(w), !0).forEach(function (_) {
                r(S, _, w[_]);
              })
            : Object.getOwnPropertyDescriptors
              ? Object.defineProperties(S, Object.getOwnPropertyDescriptors(w))
              : o(Object(w)).forEach(function (_) {
                  Object.defineProperty(
                    S,
                    _,
                    Object.getOwnPropertyDescriptor(w, _),
                  );
                });
        }
        return S;
              ...
              for (
                var M = function (G) {
                    ...
                    return new Promise(function (Y, X) {
                      var ce = _(v);
                      (v.set(ce, { reject: X, resolve: Y }),
                        V === null
                          ? O.postMessage({ id: ce, method: G }, te)
                          : O.postMessage(
                              { id: ce, method: G, params: V },
                              te,
                            ));
                    });
                  },
      ...
      function d(S) {
        for (var b = 1; b < arguments.length; b++) {
          var w = arguments[b] != null ? arguments[b] : {};
          b % 2
            ? h(Object(w), !0).forEach(function (_) {
                r(S, _, w[_]);
              })
            : Object.getOwnPropertyDescriptors
              ? Object.defineProperties(S, Object.getOwnPropertyDescriptors(w))
              : h(Object(w)).forEach(function (_) {
                  Object.defineProperty(
                    S,
                    _,
                    Object.getOwnPropertyDescriptor(w, _),
      ...
      var m = function (b) {
        ...
        P = c(f(new WeakMap()), m(new WeakMap()), e.generateUniqueNumber, g);
      t.createBroker = P;
    });
  });
  var Eg = j((Vo, Sg) => {
    ...
    (function (t, e) {
      ...
      var i = function (w) {
        ...
        h = i(c),
        d = s(f),
        m = o(r.generateUniqueNumber, c),
        g = a(r.generateUniqueNumber, f),
        P = e.createBroker({
    ...
    var BA = () =>
        typeof window < "u"
          ? typeof navigator < "u" &&
            ...
            N?.versions
            ? !Object.prototype.hasOwnProperty.call(N.versions, "electron")
      ...
      Tg = () => typeof navigator < "u" && navigator.product === "ReactNative",
      MA = BA() || xg() || Tg();
    Fr.isWebWorker = xg();
    Fr.isReactNativeBrowser = Tg();
    Fr.default = MA;
  });
  var kg = j((Gt) => {
    "use strict";
    ...
    var Pg = Ig(),
      Uu = LA(yi()),
      Og = { set: Pg.setInterval, clear: Pg.clearInterval },
      Rg = { set: (t, e) => setInterval(t, e), clear: (t) => clearInterval(t) },
      UA = (t) => {
        switch (t) {
          case "native":
            return Rg;
          ...
          case "auto":
          default:
            return Uu.default && !Uu.isWebWorker && !Uu.isReactNativeBrowser
              ? Og
              : Rg;
        }
      };
  ...
  var zo = j((yt) => {
    ...
    var Fu = fr(ay()),
      ...
      $u = class t extends KA.TypedEventEmitter {
        ...
        constructor(e, r) {
          ...
          for (let n in Ng)
            typeof this.options[n] > "u"
              ? (this.options[n] = Ng[n])
              : (this.options[n] = r[n]);
          ((this.log = this.options.log || (0, HA.default)("mqttjs:client")),
            ...
            this.options.writeCache ||
              (Fu.default.writeToStream.cacheNumbers = !1),
            (this.streamBuilder = e),
            (this.messageIdProvider =
              typeof this.options.messageIdProvider > "u"
                ? new GA.default()
                : this.options.messageIdProvider),
            (this.outgoingStore = r.outgoingStore || new vn.default()),
            (this.incomingStore = r.incomingStore || new vn.default()),
            (this.queueQoSZero =
            ...
            r.properties &&
              ...
              (r.properties.topicAliasMaximum > 65535
                ...
                : (this.topicAliasRecv = new zA.default(
            ...
            this.on("connect", () => {
              let { queue: n } = this,
                i = () => {
                  ...
                  ((o = s.packet),
                    this.log("deliver :: call _sendPacket for %o", o));
                  let a = !0;
                  (o.messageId &&
                    o.messageId !== 0 &&
                    (this.messageIdProvider.register(o.messageId) || (a = !1)),
                    a
                      ? this._sendPacket(o, (c) => {
                          (s.cb && s.cb(c), i());
                        })
                      : (this.log(
        ...
        connect() {
          let e = new $A.Writable(),
            r = Fu.default.parser(this.options),
            n = null,
            i = [];
          (this.log("connect :: calling method to clear reconnect"),
            ...
            this.disconnected &&
              !this.reconnecting &&
              ((this.incomingStore =
                this.options.incomingStore || new vn.default()),
              (this.outgoingStore =
                this.options.outgoingStore || new vn.default()),
              (this.disconnecting = !1),
              (this.disconnected = !1)),
            this.log(
          ...
          let s = () => {
              ...
              if (f)
                (this.log("work :: packet pulled from queue"),
                  (0, VA.default)(this, f, o));
              else {
                this.log("work :: no packets in queue");
                let h = n;
                ((n = null),
                  this.log("work :: done flag is %s", !!h),
                  h && h());
              }
            },
            o = () => {
          ...
          let a = (f) => {
            (this.log("streamErrorHandler :: error", f.message),
              f.code
        ...
        publish(e, r, n, i) {
          ...
          let m = () => {
            ...
            switch (
              (s.protocolVersion === 5 && (P.properties = h),
              ...
              case 2:
                ((this.outgoing[P.messageId] = {
                  ...
                  this.log("MqttClient:publish: packet cmd: %s", P.cmd),
                  this._sendPacket(P, void 0, d));
                break;
              default:
                (this.log("MqttClient:publish: packet cmd: %s", P.cmd),
                  this._sendPacket(P, i, d));
                break;
            }
            return !0;
          };
        ...
        subscribe(e, r, n) {
            ...
            d = (P, S) => {
              if (
                ...
                !Object.prototype.hasOwnProperty.call(
                  ...
                  this._resubscribeTopics[P].qos < S.qos ||
                  s)
              ) {
          ...
          if (
            (Array.isArray(e)
              ...
              : Object.keys(e).forEach((P) => {
                  (this.log("subscribe: object topic %s, %o", P, e[P]),
                    d(P, e[P]));
                }),
            !h.length)
          )
          ...
          let m = (P, S) => {
                ...
                (P.forEach((R) => {
                  if (this.options.reconnectPeriod > 0) {
                    ...
                    (i === 5 &&
                      ...
                      (this._resubscribeTopics[R.topic] = T),
                      _.push(R.topic));
                  }
                }),
            ...
            g = () => {
              let P = this.options.subscribeBatchSize ?? h.length,
                S = [];
          ...
          return (
            (this._storeProcessing ||
              this._storeProcessingQueue.length > 0 ||
              !g()) &&
              this._storeProcessingQueue.push({ invoke: g, callback: n }),
            this
          );
        }
        subscribeAsync(e, r) {
        ...
        unsubscribe(e, r, n) {
          ...
          let s = () => {
            ...
            return (
              ...
              this.options.resubscribe &&
                a.unsubscriptions.forEach((c) => {
                  delete this._resubscribeTopics[c];
                }),
              typeof r == "object" &&
                r.properties &&
                (a.properties = r.properties),
              (this.outgoing[a.messageId] = { volatile: !0, cb: n }),
          ...
          return (
            (this._storeProcessing ||
              this._storeProcessingQueue.length > 0 ||
              !s()) &&
              this._storeProcessingQueue.push({ invoke: s, callback: n }),
            this
          );
        }
        unsubscribeAsync(e, r) {
          ...
          (this.log("end :: (%s)", this.options.clientId),
            (e == null || typeof e != "boolean") &&
              ((n = n || r), (r = e), (e = !1)),
            typeof r != "object" && ((n = n || r), (r = null)),
            this.log("end :: cb? %s", !!n),
            (!n || typeof n != "function") && (n = this.noop));
          let i = () => {
              (this.log(
                "end :: closeStores: closing incoming and outgoing stores",
              ),
                (this.disconnected = !0),
                this.incomingStore.close((o) => {
        ...
        _removeTopicAliasAndRecoverTopicName(e) {
          ...
          if (
            ...
            if (((n = this.topicAliasSend.getTopicByAlias(r)), typeof n > "u"))
        ...
        _storeAndSend(e, r, n) {
          ...
          if (
            i.cmd === "publish" &&
            ((i = (0, Cg.default)(e)),
            (s = this._removeTopicAliasAndRecoverTopicName(i)),
            s)
          )
            return r && r(s);
              ...
              if (r) {
                ...
                n.length !== 0 &&
                  (this.options.autoAssignTopicAlias
                    ? ((r = this.topicAliasSend.getAliasByTopic(n)),
                      r
                        ? ((e.topic = ""),
                          (e.properties = { ...e.properties, topicAlias: r }),
                          this.log(
        ...
        _writePacket(e, r) {
          ...
          (this.log("_writePacket :: writeToStream result %s", n),
            !n && r && r !== this.noop
              ? (this.log(
        ...
        _storePacket(e, r, n) {
          ...
          let s = i.qos || 0;
          (s === 0 && this.queueQoSZero) || i.cmd !== "publish"
            ? this.queue.push({ packet: i, cb: r })
            : s > 0
              ? ((r = this.outgoing[i.messageId]
        ...
        _setupKeepaliveManager() {
          (this.log(
            ...
            !this.keepaliveManager &&
              this.options.keepalive &&
              (this.keepaliveManager = new QA.default(
                this,
              ...
              if (this.options.protocolVersion === 5) {
                ...
                for (let r = 0; r < e.length; r++) {
                  ...
                  ((n[e[r]] = this._resubscribeTopics[e[r]]),
                    (n.resubscribe = !0),
                    this.subscribe(n, { properties: n[e[r]].properties }));
                }
              } else
        ...
        _onConnect(e) {
          ...
          ((this.connackPacket = e),
            ...
            (this.connected = !0));
          let r = () => {
            let n = this.outgoingStore.createStream(),
              i = () => {
                (n.destroy(),
                  (n = null),
            ...
            (n.on("end", () => {
              let a = !0;
              for (let c in this._packetIdsDuringStoreProcessing)
                if (!this._packetIdsDuringStoreProcessing[c]) {
                  a = !1;
                  break;
                }
              (this.removeListener("close", i),
        ...
        _removeOutgoingAndStoreMessage(e, r) {
          (delete this.outgoing[e],
            this.outgoingStore.del({ messageId: e }, (n, i) => {
              (r(n, i),
    ...
    function R(H) {
      ...
      for (; J < ee;) {
        ...
        if (G >= 55296 && G <= 56319 && J < ee) {
          ...
          (V & 64512) == 56320
            ? z.push(((G & 1023) << 10) + (V & 1023) + 65536)
            : (z.push(G), J--);
        } else z.push(G);
      }
      return z;
    }
    let T = (H) => String.fromCodePoint(...H),
      y = function (H) {
        return H >= 48 && H < 58
          ? 26 + (H - 48)
          : H >= 65 && H < 91
      ...
      M = function (H) {
        ...
        te < 0 && (te = 0);
        for (let Y = 0; Y < te; ++Y)
          (H.charCodeAt(Y) >= 128 && b("not-basic"), z.push(H.charCodeAt(Y)));
        for (let Y = te > 0 ? te + 1 : 0; Y < J;) {
          let X = ee;
          for (let Z = 1, ne = e; ; ne += e) {
            Y >= J && b("invalid-input");
            let he = y(H.charCodeAt(Y++));
            (he >= e && b("invalid-input"),
              he > P((t - ee) / Z) && b("overflow"),
              (ee += he * Z));
      ...
      F = function (H) {
        ...
        for (te && z.push(c); Y < J;) {
          ...
          let ce = Y + 1;
          (X - ee > P((t - G) / ce) && b("overflow"),
            (G += (X - ee) * ce),
            (ee = X));
          for (let Z of H)
            if ((Z < ee && ++G > t && b("overflow"), Z === ee)) {
              let ne = G;
              for (let he = e; ; he += e) {
  ...
  function ZA() {
    return (Fg || ((Fg = !0), (Ku = Error)), Ku);
  }
  function eI() {
    return (Wg || ((Wg = !0), (Qu = EvalError)), Qu);
  }
  function tI() {
    return ($g || (($g = !0), (Yu = RangeError)), Yu);
  }
  function rI() {
    return (Hg || ((Hg = !0), (Ju = ReferenceError)), Ju);
  }
  function ab() {
    return (Vg || ((Vg = !0), (Xu = SyntaxError)), Xu);
  }
  function Sn() {
    return (Gg || ((Gg = !0), (Zu = TypeError)), Zu);
  }
  function nI() {
    return (zg || ((zg = !0), (el = URIError)), el);
  }
  function iI() {
    if (Kg) return tl;
    Kg = !0;
  ...
  function sI() {
    ...
    var t = "Function.prototype.bind called on incompatible ",
      ...
      s = function (c, f) {
        for (var h = [], d = f, m = 0; d < c.length; d += 1, m += 1)
          h[m] = c[d];
        return h;
      },
      o = function (a, c) {
        for (var f = "", h = 0; h < a.length; h += 1)
          ((f += a[h]), h + 1 < a.length && (f += c));
        return f;
      };
    return (
      (nl = function (c) {
  ...
  function Wr() {
    ...
    var d = function () {
      ...
      S =
        ...
        (P
          ...
          : null),
      b = {},
      w = typeof Uint8Array > "u" || !S ? t : S(Uint8Array),
      _ = {
        __proto__: null,
        ...
        "%MapIteratorPrototype%":
          typeof Map > "u" || !g || !S ? t : S(new Map()[Symbol.iterator]()),
        "%Math%": Math,
        "%Number%": Number,
        "%Object%": Object,
        ...
        "%SetIteratorPrototype%":
          typeof Set > "u" || !g || !S ? t : S(new Set()[Symbol.iterator]()),
        "%SharedArrayBuffer%":
    ...
    var T = function G(V) {
      ...
      O = dl(),
      v = aI(),
      M = O.call(Function.call, Array.prototype.concat),
      F = O.call(Function.apply, Array.prototype.splice),
      U = O.call(Function.call, String.prototype.replace),
      Q = O.call(Function.call, String.prototype.slice),
      W = O.call(Function.call, RegExp.prototype.exec),
      H =
        /[^%.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|%$))/g,
      z = /\\(\\)?/g,
      J = function (V) {
        ...
        for (var ye = 1, Ae = !0; ye < Y.length; ye += 1) {
          ...
          if (
            ...
            if (h && ye + 1 >= Y.length) {
              var xe = h(ne, _e);
              ((Ae = !!xe),
                Ae && "get" in xe && !("originalValue" in xe.get)
                  ? (ne = xe.get)
                  : (ne = ne[_e]));
  ...
  function cI() {
    ...
    return (
      (fl = function (a, c) {
        ...
        return (
          (h || d || !f) && (r ? e(a, "length", c, !0, !0) : e(a, "length", c)),
          a
        );
      }),
      fl
  ...
  function fI() {
    ...
    wi = function (d) {
      ...
      return r(m, 1 + c(0, d.length - (arguments.length - 1)), !0);
    };
    var f = function () {
  ...
  function dI(t) {
    ...
    if (arguments.length > 1)
      for (var r = 1; r < arguments.length; r++) e[r - 1] = arguments[r];
    (zt.push(new hb(t, e)), zt.length === 1 && !En && setTimeout(fb, 0));
  }
  function hb(t, e) {
    ((this.fun = t), (this.array = e));
  }
  ...
  function bl(t) {
    var e = Math.floor((Date.now() - dr.now()) * 0.001),
      r = dr.now() * 0.001,
      n = Math.floor(r) + e,
      i = Math.floor((r % 1) * 1e9);
    return (
      t && ((n = n - t[0]), (i = i - t[1]), i < 0 && (n--, (i += gl))),
      [n, i]
    );
  }
  function pr() {
  ...
  var zt,
    ...
    vl = ze(() => {
      ...
      dr.now === void 0 &&
        ((yl = Date.now()),
        dr.timing &&
          dr.timing.navigationStart &&
          (yl = dr.timing.navigationStart),
        (dr.now = () => Date.now() - yl));
      gl = 1e9;
  ...
  function xx() {
    ...
    function n(s, o) {
      var a = o.dir || o.root,
        c = o.base || (o.name || "") + (o.ext || "");
      return a ? (a === o.root ? a + c : a + s + c) : c;
    }
    var i = {
      resolve: function () {
        for (
          var o = "", a = !1, c, f = arguments.length - 1;
          f >= -1 && !a;
          f--
        ) {
          var h;
          (f >= 0
            ? (h = arguments[f])
            : (c === void 0 && (c = t.cwd()), (h = c)),
            e(h),
            h.length !== 0 &&
              ((o = h + "/" + o), (a = h.charCodeAt(0) === 47)));
        }
        return (
          (o = r(o, !a)),
          a ? (o.length > 0 ? "/" + o : "/") : o.length > 0 ? o : "."
        );
      },
      ...
      relative: function (o, a) {
        if (
          (e(o),
          e(a),
          o === a || ((o = i.resolve(o)), (a = i.resolve(a)), o === a))
        )
          return "";
        for (var c = 1; c < o.length && o.charCodeAt(c) === 47; ++c);
        for (
          var f = o.length, h = f - c, d = 1;
          d < a.length && a.charCodeAt(d) === 47;
          ++d
        );
        for (
          var m = a.length, g = m - d, P = h < g ? h : g, S = -1, b = 0;
          b <= P;
          ++b
        ) {
          if (b === P) {
            if (g > P) {
              ...
              h > P &&
                (o.charCodeAt(c + b) === 47 ? (S = b) : b === 0 && (S = 0));
            break;
          }
        ...
        var R = "";
        for (b = c + S + 1; b <= f; ++b)
          (b === f || o.charCodeAt(b) === 47) &&
            (R.length === 0 ? (R += "..") : (R += "/.."));
        return R.length > 0
          ? R + a.slice(d + S)
          : ((d += S), a.charCodeAt(d) === 47 && ++d, a.slice(d));
      },
      ...
      basename: function (o, a) {
        ...
        if (a !== void 0 && a.length > 0 && a.length <= o.length) {
          ...
          return (
            c === f ? (f = g) : f === -1 && (f = o.length),
            o.slice(c, f)
          );
        } else {
          for (d = o.length - 1; d >= 0; --d)
            if (o.charCodeAt(d) === 47) {
              if (!h) {
                c = d + 1;
                break;
              }
      ...
      extname: function (o) {
        e(o);
        for (
          var a = -1, c = 0, f = -1, h = !0, d = 0, m = o.length - 1;
          m >= 0;
          --m
        ) {
      ...
      parse: function (o) {
        ...
        f ? ((a.root = "/"), (h = 1)) : (h = 0);
        for (
          var d = -1, m = 0, g = -1, P = !0, S = o.length - 1, b = 0;
          S >= h;
          --S
        ) {
        ...
        return (
          ...
          (b === 1 && d === g - 1 && d === m + 1)
            ? g !== -1 &&
              (m === 0 && f
                ? (a.base = a.name = o.slice(1, g))
                : (a.base = a.name = o.slice(m, g)))
            : (m === 0 && f
                ? ((a.name = o.slice(1, d)), (a.base = o.slice(1, g)))
                : ((a.name = o.slice(m, d)), (a.base = o.slice(m, g))),
              (a.ext = o.slice(d, g))),
          m > 0 ? (a.dir = o.slice(0, m - 1)) : f && (a.dir = "/"),
          a
        );
      },
      sep: "/",
  ...
  function Px() {
    ...
    var t = typeof Map == "function" && Map.prototype,
      ...
      h = typeof WeakSet == "function" && WeakSet.prototype,
    ...
    function V(k, B) {
      ...
      if (typeof k == "number") {
        ...
        if (ie !== k) {
          var oe = String(ie),
            fe = _.call(B, oe.length + 1);
          return (
            R.call(oe, re, "$&_") +
            "." +
            R.call(R.call(fe, /([0-9]{3})/g, "$&_"), /_$/, "")
          );
        }
      }
    ...
    Al = function k(B, re, ie, oe) {
      ...
      if (
        Re(fe, "quoteStyle") &&
        fe.quoteStyle !== "single" &&
        fe.quoteStyle !== "double"
      )
        throw new TypeError('option "quoteStyle" must be "single" or "double"');
      if (
        Re(fe, "maxStringLength") &&
        (typeof fe.maxStringLength == "number"
          ? fe.maxStringLength < 0 && fe.maxStringLength !== 1 / 0
          : fe.maxStringLength !== null)
      )
        throw new TypeError(
      ...
      if (
        ...
        fe.indent !== null &&
        fe.indent !== "	" &&
        !(parseInt(fe.indent, 10) === fe.indent && fe.indent > 0)
      )
        throw new TypeError(
          'option "indent" must be "\\t", an integer > 0, or `null`',
        );
      if (Re(fe, "numericSeparator") && typeof fe.numericSeparator != "boolean")
        throw new TypeError(
      ...
      if (
        (typeof ie > "u" && (ie = 0),
        ie >= es && es > 0 && typeof B == "object")
      )
        return ne(B) ? "[Array]" : "[Object]";
      var Gr = C(fe, ie);
      if (typeof oe > "u") oe = [];
      else if (Bt(oe, B) >= 0) return "[Circular]";
      function ut(zr, Ti, Qb) {
        if ((Ti && ((oe = F.call(oe)), oe.push(Ti)), Qb)) {
          var sc = { depth: fe.depth };
          return (
            Re(fe, "quoteStyle") && (sc.quoteStyle = fe.quoteStyle),
            k(zr, sc, ie + 1, oe)
          );
        }
      ...
      if (typeof B == "function" && !be(B)) {
        ...
        return (
          ...
          (Zl ? ": " + Zl : " (anonymous)") +
          "]" +
          (ec.length > 0 ? " { " + M.call(ec, ", ") + " }" : "")
        );
      }
      if (Oe(B)) {
        var tc = z
          ? R.call(String(B), /^(Symbol\(.*\))_[^)]*$/, "$1")
          : H.call(B);
        return typeof B == "object" && !z ? p(tc) : tc;
      }
      if (Xo(B)) {
        for (
          var Pn = "<" + y.call(String(B.nodeName)),
            ts = B.attributes || [],
            xi = 0;
          xi < ts.length;
          xi++
        )
          Pn += " " + ts[xi].name + "=" + ce(Z(ts[xi].value), "double", fe);
        return (
          (Pn += ">"),
          B.childNodes && B.childNodes.length && (Pn += "..."),
          (Pn += "</" + y.call(String(B.nodeName)) + ">"),
          Pn
        );
      }
      if (ne(B)) {
      ...
      if (ye(B)) {
        ...
        return !("cause" in Error.prototype) &&
          ...
          ? "{ [" +
              String(B) +
              "] " +
              M.call(v.call("[cause]: " + ut(B.cause), ns), ", ") +
              " }"
          : ns.length === 0
            ? "[" + String(B) + "]"
            : "{ [" + String(B) + "] " + M.call(ns, ", ") + " }";
      ...
      if (typeof B == "object" && Qt) {
        if (X && typeof B[X] == "function" && te)
          return te(B, { depth: es - ie });
        if (Qt !== "symbol" && typeof B.inspect == "function")
          return B.inspect();
      }
      if (xn(B)) {
        var rc = [];
        return (
          n &&
            n.call(B, function (zr, Ti) {
              rc.push(ut(Ti, B, !0) + " => " + ut(zr, B));
            }),
          l("Map", r.call(B), rc, Gr)
        );
      }
      if (Ze(B)) {
        var nc = [];
        return (
          a &&
            a.call(B, function (zr) {
              nc.push(ut(zr, B));
            }),
          l("Set", o.call(B), nc, Gr)
        );
      }
      ...
      if (
        (typeof globalThis < "u" && B === globalThis) ||
        (typeof Il < "u" && B === Il)
      )
      ...
      if (!he(B) && !be(B)) {
        var is = $(B, ut),
          ic = G
            ? G(B) === Object.prototype
            : B instanceof Object || B.constructor === Object,
          os = B instanceof Object ? "" : "null prototype",
          oc =
            !ic && J && Object(B) === B && J in B
              ? _.call(Ne(B), 8, -1)
              : os
                ? "Object"
                : "",
          Kb =
            ic || typeof B.constructor != "function"
              ? ""
              : B.constructor.name
                ? B.constructor.name + " "
                : "",
    ...
    function ne(k) {
      return (
        Ne(k) === "[object Array]" && (!J || !(typeof k == "object" && J in k))
      );
    }
    function he(k) {
      return (
        Ne(k) === "[object Date]" && (!J || !(typeof k == "object" && J in k))
      );
    }
    function be(k) {
      return (
        Ne(k) === "[object RegExp]" && (!J || !(typeof k == "object" && J in k))
      );
    }
    function ye(k) {
      return (
        Ne(k) === "[object Error]" && (!J || !(typeof k == "object" && J in k))
      );
    }
    function Ae(k) {
      return (
        Ne(k) === "[object String]" && (!J || !(typeof k == "object" && J in k))
      );
    }
    function _e(k) {
      return (
        Ne(k) === "[object Number]" && (!J || !(typeof k == "object" && J in k))
      );
    }
    function ve(k) {
      return (
        Ne(k) === "[object Boolean]" &&
        (!J || !(typeof k == "object" && J in k))
      );
    }
    function Oe(k) {
    ...
    function at(k, B) {
      if (k.length > B.maxStringLength) {
        var re = k.length - B.maxStringLength,
          ie = "... " + re + " more character" + (re > 1 ? "s" : "");
    ...
    function Zo(k) {
      var B = k.charCodeAt(0),
        re = { 8: "b", 9: "t", 10: "n", 12: "f", 13: "r" }[B];
      return re
        ? "\\" + re
        : "\\x" + (B < 16 ? "0" : "") + T.call(B.toString(16));
    }
    function p(k) {
      return "Object(" + k + ")";
    }
...
` +
    ...
    function $(k, B) {
      ...
      if (re) {
        ...
        for (var oe = 0; oe < k.length; oe++)
          ie[oe] = Re(k, oe) ? B(k[oe], k) : "";
      }
      var fe = typeof W == "function" ? W(k) : [],
        Qt;
      if (z) {
        Qt = {};
      ...
      for (var Ye in k)
        Re(k, Ye) &&
          ((re && String(Number(Ye)) === Ye && Ye < k.length) ||
            (z && Qt["$" + Ye] instanceof Symbol) ||
            (O.call(/[^\w$]/, Ye)
              ? ie.push(B(Ye, k) + ": " + B(k[Ye], k))
              : ie.push(Ye + ": " + B(k[Ye], k))));
      if (typeof W == "function")
        for (var Yt = 0; Yt < fe.length; Yt++)
          ee.call(k, fe[Yt]) &&
            ie.push("[" + B(fe[Yt]) + "]: " + B(k[fe[Yt]], k));
      return ie;
    }
    return Al;
  }
  function Ox() {
    ...
    var t = Wr(),
      ...
      c = e("WeakMap.prototype.has", !0),
      f = e("Map.prototype.get", !0),
      h = e("Map.prototype.set", !0),
      d = e("Map.prototype.has", !0),
      m = function (b, w) {
        for (var _ = b, R; (R = _.next) !== null; _ = R)
          if (R.key === w)
            return ((_.next = R.next), (R.next = b.next), (b.next = R), R);
      },
      g = function (b, w) {
        var _ = m(b, w);
        return _ && _.value;
      ...
      (xl = function () {
        var w,
          ...
          T = {
            assert: function (y) {
              if (!T.has(y))
                throw new n("Side channel does not contain " + r(y));
            },
            get: function (y) {
            ...
            set: function (y, O) {
              i && y && (typeof y == "object" || typeof y == "function")
                ? (w || (w = new i()), a(w, y, O))
                : s
                  ? (_ || (_ = new s()), h(_, y, O))
                  : (R || (R = { key: {}, next: null }), P(R, y, O));
            },
          };
        return T;
      }),
  ...
  function Eb() {
    ...
    var t = Bl(),
      ...
      i = function (w) {
        for (; w.length > 1;) {
          var _ = w.pop(),
            R = _.obj[_.prop];
          if (r(R)) {
            for (var T = [], y = 0; y < R.length; ++y)
              typeof R[y] < "u" && T.push(R[y]);
            _.obj[_.prop] = T;
          }
        }
      },
      s = function (w, _) {
        for (
          var R = _ && _.plainObjects ? Object.create(null) : {}, T = 0;
          T < w.length;
          ++T
        )
          typeof w[T] < "u" && (R[T] = w[T]);
        return R;
      },
      o = function b(w, _, R) {
        if (!_) return w;
        ...
        return (
          r(w) && !r(_) && (T = s(w, R)),
          r(w) && r(_)
            ? (_.forEach(function (y, O) {
                if (e.call(w, O)) {
                  var v = w[O];
                  v && typeof v == "object" && y && typeof y == "object"
                    ? (w[O] = b(v, y, R))
                    : w.push(y);
                } else w[O] = y;
              }),
              w)
            : Object.keys(_).reduce(function (y, O) {
                var v = _[O];
      ...
      f = 1024,
      h = function (w, _, R, T, y) {
        if (w.length === 0) return w;
        var O = w;
        if (
          (typeof w == "symbol"
            ? (O = Symbol.prototype.toString.call(w))
            : typeof w != "string" && (O = String(w)),
          R === "iso-8859-1")
        )
        ...
        for (var v = "", M = 0; M < O.length; M += f) {
          for (
            var F = O.length >= f ? O.slice(M, M + f) : O, U = [], Q = 0;
            Q < F.length;
            ++Q
          ) {
            ...
            ((Q += 1),
              (W = 65536 + (((W & 1023) << 10) | (F.charCodeAt(Q) & 1023))),
              (U[U.length] =
                n[240 | (W >> 18)] +
                n[128 | ((W >> 12) & 63)] +
                n[128 | ((W >> 6) & 63)] +
      ...
      d = function (w) {
        for (
          var _ = [{ obj: { o: w }, prop: "o" }], R = [], T = 0;
          T < _.length;
          ++T
        )
          for (
            var y = _[T], O = y.obj[y.prop], v = Object.keys(O), M = 0;
            M < v.length;
            ++M
          ) {
            var F = v[M],
  ...
  function Rx() {
    ...
    var t = Ox(),
      ...
      m = {},
      g = function S(b, w, _, R, T, y, O, v, M, F, U, Q, W, H, z, J, ee, G) {
        for (
          var V = b, te = G, Y = 0, X = !1;
          (te = te.get(m)) !== void 0 && !X;
        ) {
          var ce = te.get(b);
          if (((Y += 1), typeof ce < "u")) {
        ...
        var he;
        if (_ === "comma" && s(V))
          (J && M && (V = e.maybeMap(V, M)),
            (he = [{ value: V.length > 0 ? V.join(",") || null : void 0 }]));
        else if (s(F)) he = F;
        else {
          var be = Object.keys(V);
          he = U ? be.sort(U) : be;
        }
        var ye = v ? w.replace(/\./g, "%2E") : w,
          Ae = R && s(V) && V.length === 1 ? ye + "[]" : ye;
        if (T && s(V) && V.length === 0) return Ae + "[]";
        for (var _e = 0; _e < he.length; ++_e) {
          var ve = he[_e],
            Oe =
              typeof ve == "object" && typeof ve.value < "u" ? ve.value : V[ve];
          if (!(O && Oe === null)) {
            var xe = Q && v ? ve.replace(/\./g, "%2E") : ve,
              st = s(V)
                ? typeof _ == "function"
                  ? _(Ae, xe)
                  : Ae
      ...
      P = function (b) {
        ...
        if (typeof b.format < "u") {
          if (!n.call(r.formatters, b.format))
            throw new TypeError("Unknown format option provided.");
          _ = b.format;
        }
        var R = r.formatters[_],
          T = h.filter;
        ...
        return {
          ...
          serializeDate:
            typeof b.serializeDate == "function"
              ...
              : h.serializeDate,
          skipNulls:
            typeof b.skipNulls == "boolean" ? b.skipNulls : h.skipNulls,
    ...
    return (
      (Ol = function (S, b) {
        ...
        typeof _.filter == "function"
          ? ((T = _.filter), (w = T("", w)))
          : s(_.filter) && ((T = _.filter), (R = T));
        var y = [];
        if (typeof w != "object" || w === null) return "";
        var O = i[_.arrayFormat],
          v = O === "comma" && _.commaRoundTrip;
        (R || (R = Object.keys(w)), _.sort && R.sort(_.sort));
        for (var M = t(), F = 0; F < R.length; ++F) {
          var U = R[F];
          (_.skipNulls && w[U] === null) ||
            a(
              y,
              g(
                w[U],
  ...
  function kx() {
    ...
    var t = Eb(),
      ...
      s = function (m, g) {
        return m && typeof m == "string" && g.comma && m.indexOf(",") > -1
          ? m.split(",")
          : m;
      },
      ...
      c = function (g, P) {
        var S = { __proto__: null },
          b = P.ignoreQueryPrefix ? g.replace(/^\?/, "") : g;
        b = b.replace(/%5B/gi, "[").replace(/%5D/gi, "]");
        var w = P.parameterLimit === 1 / 0 ? void 0 : P.parameterLimit,
          _ = b.split(P.delimiter, w),
          R = -1,
          T,
          y = P.charset;
        if (P.charsetSentinel)
          for (T = 0; T < _.length; ++T)
            _[T].indexOf("utf8=") === 0 &&
              (_[T] === a ? (y = "utf-8") : _[T] === o && (y = "iso-8859-1"),
              (R = T),
              (T = _.length));
        for (T = 0; T < _.length; ++T)
          if (T !== R) {
            var O = _[T],
              ...
              U;
            (M === -1
              ? ((F = P.decoder(O, n.decoder, y, "key")),
                (U = P.strictNullHandling ? null : ""))
              : ((F = P.decoder(O.slice(0, M), n.decoder, y, "key")),
                (U = t.maybeMap(s(O.slice(M + 1), P), function (W) {
              ...
              U &&
                ...
                y === "iso-8859-1" &&
                (U = i(U)),
              O.indexOf("[]=") > -1 && (U = r(U) ? [U] : U));
            var Q = e.call(S, F);
            Q && P.duplicates === "combine"
              ? (S[F] = t.combine(S[F], U))
              : (!Q || P.duplicates === "last") && (S[F] = U);
          }
        return S;
      },
      f = function (m, g, P, S) {
          ...
          if (R === "[]" && P.parseArrays)
            ...
            var T =
                R.charAt(0) === "[" && R.charAt(R.length - 1) === "]"
                  ? R.slice(1, -1)
                  : R,
              y = P.decodeDotInKeys ? T.replace(/%2E/g, ".") : T,
              O = parseInt(y, 10);
            !P.parseArrays && y === ""
              ? (_ = { 0: b })
              : !isNaN(O) &&
      ...
      h = function (g, P, S, b) {
        if (g) {
          var w = S.allowDots ? g.replace(/\.([^.[]+)/g, "[$1]") : g,
            _ = /(\[[^[\]]*])/,
            R = /(\[[^[\]]*])/g,
            T = S.depth > 0 && _.exec(w),
            y = T ? w.slice(0, T.index) : w,
            O = [];
          if (y) {
            if (
              !S.plainObjects &&
              e.call(Object.prototype, y) &&
              !S.allowPrototypes
            )
              return;
            O.push(y);
          ...
          for (
            var v = 0;
            S.depth > 0 && (T = R.exec(w)) !== null && v < S.depth;
          ) {
            if (
              ((v += 1),
              !S.plainObjects &&
                e.call(Object.prototype, T[1].slice(1, -1)) &&
                !S.allowPrototypes)
            )
              return;
            O.push(T[1]);
      ...
      d = function (g) {
        ...
        var P = typeof g.charset > "u" ? n.charset : g.charset,
          S = typeof g.duplicates > "u" ? n.duplicates : g.duplicates;
        ...
        return {
          ...
          delimiter:
            typeof g.delimiter == "string" || t.isRegExp(g.delimiter)
              ? g.delimiter
              : n.delimiter,
          depth:
    ...
    return (
      (Rl = function (m, g) {
        ...
        for (
          var S = typeof m == "string" ? c(m, P) : m,
            b = P.plainObjects ? Object.create(null) : {},
            w = Object.keys(S),
            _ = 0;
          _ < w.length;
          ++_
...
`,
    ...
    e.prototype.parse = function (y, O, v) {
      if (typeof y != "string")
        throw new TypeError(
          "Parameter 'url' must be a string, not " + typeof y,
        );
      var M = y.indexOf("?"),
        F = M !== -1 && M < y.indexOf("#") ? "?" : "#",
        U = y.split(F),
        ...
        if (H)
          return (
            ...
            H[2]
              ? ((this.search = H[2]),
                O
                  ? (this.query = b.parse(this.search.substr(1)))
      ...
      if (!P[z] && (ee || (z && !S[z]))) {
        ...
        var Y, X;
        (G === -1 ? (X = W.lastIndexOf("@")) : (X = W.lastIndexOf("@", G)),
          X !== -1 &&
            ((Y = W.slice(0, X)),
            (W = W.slice(X + 1)),
        ...
        if (!ce)
          for (
            var Z = this.hostname.split(/\./), V = 0, ne = Z.length;
            V < ne;
            V++
          ) {
            var he = Z[V];
            if (he && !he.match(d)) {
              for (var be = "", ye = 0, Ae = he.length; ye < Ae; ye++)
                he.charCodeAt(ye) > 127 ? (be += "x") : (be += he[ye]);
              if (!be.match(d)) {
                var _e = Z.slice(0, V),
                  ve = Z.slice(V + 1),
                  Oe = he.match(m);
                (Oe && (_e.push(Oe[1]), ve.unshift(Oe[2])),
                  ve.length && (W = "/" + ve.join(".") + W),
                  (this.hostname = _e.join(".")));
                break;
              }
            }
          }
        (this.hostname.length > h
          ...
          ce || (this.hostname = t.toASCII(this.hostname)));
        var xe = this.port ? ":" + this.port : "",
          st = this.hostname || "";
        ((this.host = st + xe),
          (this.href += this.host),
          ce &&
      ...
      if (
        (Bt !== -1
          ? ((this.search = W.substr(Bt)),
            (this.query = W.substr(Bt + 1)),
            O && (this.query = b.parse(this.query)),
            (W = W.slice(0, Bt)))
          : O && ((this.search = ""), (this.query = {})),
        W && (this.pathname = W),
        S[J] && this.hostname && !this.pathname && (this.pathname = "/"),
        this.pathname || this.search)
      ) {
        var xe = this.pathname || "",
          xn = this.search || "";
        this.path = xe + xn;
      }
    ...
    function _(y) {
      return (
        typeof y == "string" && (y = w(y)),
        y instanceof e ? y.format() : e.prototype.format.call(y)
      );
    }
    e.prototype.format = function () {
      var y = this.auth || "";
      y &&
        ((y = encodeURIComponent(y)), (y = y.replace(/%3A/i, ":")), (y += "@"));
      var O = this.protocol || "",
        v = this.pathname || "",
        M = this.hash || "",
        F = !1,
      ...
      return (
        O && O.substr(-1) !== ":" && (O += ":"),
        this.slashes || ((!O || S[O]) && F !== !1)
          ? ((F = "//" + (F || "")), v && v.charAt(0) !== "/" && (v = "/" + v))
          : F || (F = ""),
        M && M.charAt(0) !== "#" && (M = "#" + M),
        Q && Q.charAt(0) !== "?" && (Q = "?" + Q),
        (v = v.replace(/[?#]/g, function (W) {
    ...
    return (
      (e.prototype.resolveObject = function (y) {
        if (typeof y == "string") {
          var O = new e();
          (O.parse(y, !1, !0), (y = O));
        }
        ...
        if (y.protocol && y.protocol !== v.protocol) {
          ...
          if (((v.protocol = y.protocol), !y.host && !P[y.protocol])) {
            for (
              var ne = (y.pathname || "").split("/");
              ne.length && !(y.host = ne.shift());
            );
            (y.host || (y.host = ""),
              y.hostname || (y.hostname = ""),
              ne[0] !== "" && ne.unshift(""),
          ...
          return (
            (v.slashes = v.slashes || y.slashes),
            (v.href = v.format()),
            v
          );
        }
        var te = v.pathname && v.pathname.charAt(0) === "/",
          Y = y.host || (y.pathname && y.pathname.charAt(0) === "/"),
          X = Y || te || (v.host && y.pathname),
          ce = X,
          Z = (v.pathname && v.pathname.split("/")) || [],
          ne = (y.pathname && y.pathname.split("/")) || [],
          he = v.protocol && !S[v.protocol];
        if (
          (he &&
            ((v.hostname = ""),
            (v.port = null),
            v.host && (Z[0] === "" ? (Z[0] = v.host) : Z.unshift(v.host)),
            (v.host = ""),
            y.protocol &&
              ((y.hostname = null),
              (y.port = null),
              y.host && (ne[0] === "" ? (ne[0] = y.host) : ne.unshift(y.host)),
              (y.host = null)),
            (X = X && (ne[0] === "" || Z[0] === ""))),
          Y)
        )
          ((v.host = y.host || y.host === "" ? y.host : v.host),
            (v.hostname =
              y.hostname || y.hostname === "" ? y.hostname : v.hostname),
            (v.search = y.search),
            (v.query = y.query),
            (Z = ne));
        else if (ne.length)
          ...
          return (
            (v.search = y.search),
            (v.query = y.query),
            (v.pathname !== null || v.search !== null) &&
              (v.path =
                (v.pathname ? v.pathname : "") + (v.search ? v.search : "")),
            (v.href = v.format()),
            v
          );
        }
        if (!Z.length)
          return (
            (v.pathname = null),
            v.search ? (v.path = "/" + v.search) : (v.path = null),
            (v.href = v.format()),
            v
          );
        for (
        ...
        (X && Z[0] !== "" && (!Z[0] || Z[0].charAt(0) !== "/") && Z.unshift(""),
          Ae && Z.join("/").substr(-1) !== "/" && Z.push(""));
        var Oe = Z[0] === "" || (Z[0] && Z[0].charAt(0) === "/");
        if (he) {
          ((v.hostname = Oe ? "" : Z.length ? Z.shift() : ""),
            (v.host = v.hostname));
          var be = v.host && v.host.indexOf("@") > 0 ? v.host.split("@") : !1;
          be &&
            ((v.auth = be.shift()),
        ...
        return (
          ...
          Z.length > 0
            ? (v.pathname = Z.join("/"))
            : ((v.pathname = null), (v.path = null)),
          (v.pathname !== null || v.search !== null) &&
            (v.path =
              (v.pathname ? v.pathname : "") + (v.search ? v.search : "")),
          (v.auth = y.auth || v.auth),
          (v.slashes = v.slashes || y.slashes),
          (v.href = v.format()),
          v
        );
      ...
      (e.prototype.parseHost = function () {
        ...
        (O &&
          ...
          (y = y.substr(0, y.length - O.length))),
          y && (this.hostname = y));
      }),
      (Hr.parse = w),
      (Hr.resolve = R),
  ...
  function Jx(t) {
    ...
    for (let n = 0; n < r.length; n++)
      if (r[n] === "%") {
        ...
        if ((r[n + 1] === "2" && i === 102) || (r[n + 1] === "5" && i === 99))
          throw new Deno.errors.InvalidData(
            "must not include encoded \\ or / characters",
          );
      }
    if (((r = r.replace(Vx, "\\")), (r = decodeURIComponent(r)), e !== ""))
      return `\\\\${e}${r}`;
    {
      let n = r.codePointAt(1) | 32,
        i = r[2];
      if (n < $x || n > Hx || i !== ":")
  ...
  function Ib(t) {
    ...
    let n = new URL("file://");
    return (
      e.includes("%") && (e = e.replace(Gx, "%25")),
      !Cl && e.includes("\\") && (e = e.replace(zx, "%5C")),
      e.includes(`
`) && (e = e.replace(Kx, "%0A")),
      e.includes("\r") && (e = e.replace(Qx, "%0D")),
      e.includes("	") && (e = e.replace(Yx, "%09")),
      (n.pathname = e),
      n
    );
  }
  ...
  var Qo = j((mi) => {
    ...
    function kb(t, e) {
      ...
      for (let n = 0; n < t.length; n++)
        typeof t[n].chunk == "string"
          ? (r[n] = Rb.Buffer.from(t[n].chunk, "utf8"))
          : (r[n] = t[n].chunk);
      this._write(Rb.Buffer.concat(r), "binary", e);
    }
    var Ml = class extends Zx.Duplex {
      ...
      constructor(e, r, n) {
        (super({ objectMode: !0 }),
          ...
          (this.socket = n),
          (this.writeQueue = []),
          e.objectMode || (this._writev = kb.bind(this)),
          (this.isSocketOpen = !1),
      ...
      _write(e, r, n) {
        this.isSocketOpen
          ...
          : this.writeQueue.push({ chunk: e, encoding: r, cb: n });
      }
      _final(e) {
  ...
  var _i = j((gr) => {
    ...
    var Yo = (ke(), me(qe)),
      ...
      rT = ql(yi()),
      Nl = Qo(),
      yr = (0, eT.default)("mqttjs:ws"),
      nT = ["rejectUnauthorized", "ca", "cert", "key", "pfx", "passphrase"];
    function Bb(t, e) {
    ...
    function oT(t, e, r) {
      (yr("createWebSocket"),
        yr(`protocol: ${r.protocolId} ${r.protocolVersion}`));
      let n =
      ...
      return (
        r.createWebsocket
          ? (i = r.createWebsocket(e, [n], r))
          : (i = new Cb.default(e, [n], r.wsOptions)),
        i
      );
    }
    function sT(t, e) {
    ...
    var aT = (t, e) => {
      ...
      let n = Bb(r, t),
        i = oT(t, n, r),
        s = Cb.default.createWebSocketStream(i, r.wsOptions);
      return (
        (s.url = n),
        i.on("close", () => {
          s.destroy();
    ...
    var uT = (t, e) => {
      ...
      let r,
        i = iT(e).browserBufferSize || 1024 * 512,
        s = e.browserBufferTimeout || 1e3,
        o = !e.objectMode,
        a = sT(t, e),
        c = h(e, S, b);
      (e.objectMode || (c._writev = Nl.writev.bind(c)),
        c.on("close", () => {
          a.close();
        }));
      ...
      (a.readyState === a.OPEN
        ? ((r = c), (r.socket = a))
        : ((r = new Nl.BufferedDuplex(e, c, a)),
          f ? a.addEventListener("open", d) : (a.onopen = d)),
        f
          ? (a.addEventListener("close", m),
            a.addEventListener("error", g),
            a.addEventListener("message", P))
          : ((a.onclose = m), (a.onerror = g), (a.onmessage = P)));
      function h(w, _, R) {
      ...
      function d() {
        (yr("WebSocket onOpen"),
          r instanceof Nl.BufferedDuplex && r.socketReady());
      }
      function m(w) {
      ...
      async function P(w) {
        ...
        (_ instanceof ArrayBuffer
          ? (_ = Yo.Buffer.from(_))
          : _ instanceof Blob
            ? (_ = Yo.Buffer.from(await new Response(_).arrayBuffer()))
            : (_ = Yo.Buffer.from(_, "utf8")),
          c.push(_));
      }
      function S(w, _, R) {
    ...
    var cT = jl((Ul(), me(Ll))),
      ...
      pT = (t, e) => {
        if (
          ...
          return (0, hT.default)(e.hostname, e.port, e.socksProxy, {
            timeout: e.socksTimeout,
          });
        let { port: r, path: n } = e,
          i = e.hostname;
        return (
          dT("port %d and host %s", r, i),
          cT.default.createConnection({ port: r, host: i, path: n })
        );
      };
    vi.default = pT;
  });
  ...
  var Gl = j((Vl) => {
    ...
    function xT(t, e) {
      ...
      return (
        t.port &&
          t.port !== 80 &&
          t.port !== 443 &&
          (n = `${r}://${t.hostname}:${t.port}${t.path}`),
        typeof t.transformWsUrl == "function" &&
          (n = t.transformWsUrl(n, t, e)),
        n
      );
    }
    function TT() {
    ...
    var PT = (t, e) => {
      ...
      IT(e);
      let n = xT(e, t);
      ((kt = wx.connectSocket({ url: n, protocols: [r] })),
        (Hl = AT()),
        (Xe = new ET.BufferedDuplex(e, Hl, kt)),
        (Xe._destroy = (s, o) => {
          kt.close({
            success() {
              o && o(s);
  ...
  var Ql = j((Kl) => {
    ...
    var NT = (t, e) => {
      ...
      return (
        (Kt = e.my),
        Kt.connectSocket({ url: n, protocols: r }),
        (Ei = kT()),
        (An = new RT.BufferedDuplex(e, Ei, Kt)),
        MT(),
        An
      );
    };
  ...
  var $b = j((In) => {
    ...
    function DT() {
      return typeof location < "u"
        ? location.protocol === "https:"
          ? "wss"
          : "ws"
        : typeof document < "u" && new URL(document.URL).protocol === "https:"
          ? "wss"
          : "ws";
    }
    function jT(t) {
    ...
    function Wb(t, e) {
      if (
        (Fb("connecting to an MQTT broker..."),
        typeof t == "object" && !e && ((e = t), (t = "")),
        (e = e || {}),
        t && typeof t == "string")
      ) {
        let i = LT.default.parse(t, !0),
          s = {},
          o =
            !i.protocol &&
            !i.hostname &&
            i.path?.startsWith("/") &&
            (Yl.default || e.forceNativeWebSocket);
        if (
          (i.port != null && (s.port = Number(i.port)),
          (s.host = i.hostname),
          (s.query = i.query),
          (s.auth = i.auth),
        ...
        e.protocol = (e.protocol || DT()).replace(/:$/, "");
      }
      if (
        ((e.unixSocket = e.unixSocket || e.protocol?.includes("+unix")),
        e.unixSocket
          ? (e.protocol = e.protocol.replace("+unix", ""))
          : !e.protocol?.startsWith("ws") &&
            !e.protocol?.startsWith("wx") &&
            delete e.path,
        jT(e),
        e.query &&
          typeof e.query.clientId == "string" &&
          (e.clientId = e.query.clientId),
        Yl.default || e.unixSocket
          ? (e.socksProxy = void 0)
          : e.socksProxy === void 0 &&
            typeof N < "u" &&
            (e.socksProxy = N.env.MQTTJS_SOCKS_PROXY),
        e.cert && e.key)
      )
        if (e.protocol) {
      ...
      if (
        (Me ||
          ((Me = {}),
          !Yl.default && !e.forceNativeWebSocket
            ? ((Me.ws = _i().streamBuilder),
              (Me.wss = _i().streamBuilder),
              (Me.mqtt = Fl().default),
              (Me.tcp = Fl().default),
              (Me.ssl = $l().default),
              (Me.tls = Me.ssl),
              (Me.mqtts = $l().default))
            : ((Me.ws = _i().browserStreamBuilder),
              (Me.wss = _i().browserStreamBuilder),
              (Me.wx = Gl().default),
              (Me.wxs = Gl().default),
              (Me.ali = Ql().default),
              (Me.alis = Ql().default))),
        ...
        e.protocol = [
          ...
          i && o % 2 === 0 ? !1 : typeof Me[s] == "function",
        )[0];
      }
      ...
      function r(i) {
        return (
          e.servers &&
            ((!i._reconnectCount || i._reconnectCount === e.servers.length) &&
              (i._reconnectCount = 0),
            (e.host = e.servers[i._reconnectCount].host),
            (e.port = e.servers[i._reconnectCount].port),
            (e.protocol = e.servers[i._reconnectCount].protocol
              ? e.servers[i._reconnectCount].protocol
              : e.defaultProtocol),
            (e.hostname = e.host),
            i._reconnectCount++),
          Fb("calling streambuilder for", e.protocol),
          Me[e.protocol](i, e)
        );
      }
  ...
  var Xl = j((ge) => {
    ...
    ge.ReasonCodes =
      ge.KeepaliveManager =
      ge.UniqueMessageIdProvider =
      ge.DefaultMessageIdProvider =
      ge.Store =
      ge.MqttClient =
      ge.connectAsync =
      ge.connect =
    ...
    var HT = Ai(Iu());
    ge.DefaultMessageIdProvider = HT.default;
    var VT = Ai(Lg());
    ge.UniqueMessageIdProvider = VT.default;
    var GT = Ai(Ua());
    ge.Store = GT.default;
    var Gb = $T($b());
    ...
    var zT = Ai(ju());
    ge.KeepaliveManager = zT.default;
